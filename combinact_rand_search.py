...
def run_experiment(actfun, seed, outfile_path):
    ...
    if actfun == 'l2':
        ...
        adam_eps = np.exp(rng.uniform(-21.2019, -16.0049))
        adam_wd = np.exp(rng.uniform(-13.421, -9.628))
        base_lr = 10 ** (-8)
        max_lr = np.exp(rng.uniform(-5.0193, -3.1874))
        ...
        adam_eps = np.exp(rng.uniform(-19.9802, -16.6967))
        adam_wd = np.exp(rng.uniform(-12.4787, -9.3966))
        base_lr = 10 ** (-8)
        max_lr = np.exp(rng.uniform(-5.0503, -3.5588))
        ...
        adam_eps = np.exp(rng.uniform(-21.302, -16.3239))
        adam_wd = np.exp(rng.uniform(-13.4115, -9.8473))
        base_lr = 10 ** (-8)
        max_lr = np.exp(rng.uniform(-5.114, -3.511))
        ...
        adam_eps = np.exp(rng.uniform(-20.4337, -16.4012))
        adam_wd = np.exp(rng.uniform(-14.4059, -9.8197))
        base_lr = 10 ** (-8)
        max_lr = np.exp(rng.uniform(-4.9212, -3.1667))
        ...
        adam_eps = np.exp(rng.uniform(-20.5796, -15.787))
        adam_wd = np.exp(rng.uniform(-12.8655, -9.466))
        base_lr = 10 ** (-8)
        max_lr = np.exp(rng.uniform(-5.1372, -4.0357))
        ...
        adam_eps = np.exp(rng.uniform(-20.6917, -16.7904))
        adam_wd = np.exp(rng.uniform(-13.8422, -11.6871))
        base_lr = 10 ** (-8)
        max_lr = np.exp(rng.uniform(-4.872, -3.2421))
        ...
        adam_eps = np.exp(rng.uniform(-20.4646, -16.4248))
        adam_wd = np.exp(rng.uniform(-13.5709, -10.5091))
        base_lr = 10 ** (-8)
        max_lr = np.exp(rng.uniform(-3.8973, -2.4824))
