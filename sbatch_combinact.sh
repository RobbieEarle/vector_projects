...
#SBATCH --output=logs/e1_pk_exp/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=e1_pk_exp
...
python engine.py --seed $SEED --save_path $SAVE_PATH --actfun pk_test --dataset mnist --model nn --var_k
python engine.py --seed $SEED --save_path $SAVE_PATH --actfun pk_test --dataset mnist --model nn --var_p
python engine.py --seed $SEED --save_path $SAVE_PATH --actfun pk_test --dataset mnist --model cnn --var_k
python engine.py --seed $SEED --save_path $SAVE_PATH --actfun pk_test --dataset mnist --model cnn --var_p
