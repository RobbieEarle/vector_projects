...
#SBATCH --output=logs/cmbnct_rs2_cnn_cifar101d/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=cmbnct_rs2_cnn_cifar101d
...
python train.py --seed $SEED --save_path $SAVE_PATH --dataset cifar10 --sample_size 50000 --actfun 1d --randsearch
