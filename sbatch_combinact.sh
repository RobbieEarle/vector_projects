...
#SBATCH --array=0-24%12                     # array value
#SBATCH --output=logs/e9_resnet/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=e9_resnet
...
python engine.py --seed $SEED --save_path $SAVE_PATH --check_path $CHECK_DIR --model resnet --dataset $DATASET --actfun $ACTFUN --resnet_ver 34 --resnet_width 2 --num_epochs 50
