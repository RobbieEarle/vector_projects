...
#SBATCH --output=logs/resnet_test/t21-%a-%N-%j    # %N for node name, %j for jobID
...
python engine.py --seed $SEED --save_path $SAVE_PATH --check_path $CHECK_DIR --model resnet --dataset cifar10 --actfun relu --resnet_ver 34 --resnet_width 2 --num_epochs 50
