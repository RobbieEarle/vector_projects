...
#SBATCH --output=logs/cmbnct_rs3_cnn_mnist/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=cmbnct_rs3_cnn_mnist
...
python train.py --seed $SEED --save_path $SAVE_PATH --dataset mnist --sample_size 60000 --randsearch
