...
#SBATCH --output=logs/e4_nparam_log/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=e4_nparam_log
...
python engine.py --seed $SEED --save_path $SAVE_PATH --model mlp --dataset cifar10 --actfun combinact --var_n_params_log
python engine.py --seed $SEED --save_path $SAVE_PATH --model mlp --dataset cifar100 --actfun combinact --var_n_params_log
