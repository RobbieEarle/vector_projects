...
#SBATCH --output=logs/lr_range7/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=lr_range7
...
python engine.py --seed $SEED --save_path $SAVE_PATH --check_path $CHECK_DIR --optim onecycle --model resnet --dataset cifar100 --actfun $ACTFUN --validation --lr_range
