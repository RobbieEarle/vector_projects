...
#SBATCH --output=logs/e8_swish_rs1/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=e8_swish_rs1
...
python engine.py --seed $SEED --save_path $SAVE_PATH --check_path $CHECK_DIR --model mlp --dataset mnist --actfun swishk --num_epochs 10
...
python engine.py --seed $SEED --save_path $SAVE_PATH --check_path $CHECK_DIR --model mlp --dataset mnist --actfun swishk --p 2 perm_method invert --num_epochs 10
python engine.py --seed $SEED --save_path $SAVE_PATH --check_path $CHECK_DIR --model cnn --dataset mnist --actfun swishk --p 2 --perm_method invert --num_epochs 10