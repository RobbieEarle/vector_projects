...
#SBATCH --output=logs/e2_pk_exp/%a-%N-%j    # %N for node name, %j for jobID
#SBATCH --job-name=e2_pk_exp
...
python engine.py --seed $SEED --save_path $SAVE_PATH --actfun all_pk_new --dataset cifar100 --model cnn --var_p
