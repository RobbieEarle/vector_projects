...
#SBATCH --output=logs/resnet_test/t10-%a-%N-%j    # %N for node name, %j for jobID
...
python engine.py --seed $SEED --save_path $SAVE_PATH --check_path $CHECK_DIR --model dawnnet --dataset cifar10 --actfun relu --num_epochs 35 --batch_size 128
