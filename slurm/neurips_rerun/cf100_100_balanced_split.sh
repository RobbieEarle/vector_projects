...
echo ""
# Input handling
SAVE_PATH=~/vector_projects/outputs/neurips_split/cf100_100_balanced
DATASET="cifar100"
EPOCHS=100
SEED="$1"
RESNET_TYPE="$2"
...
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 3 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --split_batch --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 5 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --split_batch --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 6 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --split_batch --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 7 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --split_batch --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 8 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --split_batch --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
echo ""
