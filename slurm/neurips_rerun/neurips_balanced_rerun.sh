...
echo ""
# Input handling
SAVE_PATH=~/vector_projects/outputs/neurips_balanced_rerun/
EPOCHS=100
SEED="$1"
RESNET_TYPE="$2"
echo "SEED = $SEED"
...
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 3 --optim onecycle --num_epochs $EPOCHS --dataset "cifar10" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf10_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 6 --optim onecycle --num_epochs $EPOCHS --dataset "cifar10" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf10_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 7 --optim onecycle --num_epochs $EPOCHS --dataset "cifar10" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf10_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 8 --optim onecycle --num_epochs $EPOCHS --dataset "cifar10" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf10_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"

python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 3 --optim onecycle --num_epochs $EPOCHS --dataset "cifar100" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf100_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 6 --optim onecycle --num_epochs $EPOCHS --dataset "cifar100" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf100_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 7 --optim onecycle --num_epochs $EPOCHS --dataset "cifar100" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf100_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 8 --optim onecycle --num_epochs $EPOCHS --dataset "cifar100" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label cf100_${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
echo ""
