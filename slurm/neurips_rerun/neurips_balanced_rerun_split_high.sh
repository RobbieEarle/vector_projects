...
#SBATCH --output=logs/neurips_balanced_rerun_split_high/%x_%A-%a_%n-%t.out
#SBATCH --job-name=neurips_balanced_rerun_split_high
#SBATCH --qos=high
...
echo ""
# Input handling
SAVE_PATH="$PWD/outputs/neurips_balanced_rerun_split_high/"
EPOCHS=100
SEED="$1"
shift
RESNET_TYPE="$1"
