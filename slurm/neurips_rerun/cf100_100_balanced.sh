...
#SBATCH --output=logs_new/neurips_split/%x_%A-%a_%n-%t.out
...
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 0 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 1 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 2 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 3 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 4 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 5 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 6 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 7 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 8 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 9 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 10 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
python engine.py --seed "$SEED" --save_path "$SAVE_PATH" --check_path "$CKPT_DIR" --model resnet --batch_size 128 --actfun_idx 11 --optim onecycle --num_epochs $EPOCHS --dataset "$DATASET" --aug --mix_pre_apex --bs_factor 0.75 --balanced --resnet_type "$RESNET_TYPE" --label _${RESNET_TYPE}_${ACTFUN_IDX} "${@:5}"
echo ""
