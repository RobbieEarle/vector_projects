...
#SBATCH --output=logs_new/cf10_100_12_balanced/%x_%A-%a_%n-%t.out
#SBATCH --job-name=cf10_100_12_balanced
#SBATCH --qos=normal
...
echo ""
# Input handling
SAVE_PATH=~/vector_projects/outputs/seed_exp/cf10_100_12_balanced
DATASET="cifar10"
EPOCHS=100
RESNET_TYPE="$1"
SEED="$2"
