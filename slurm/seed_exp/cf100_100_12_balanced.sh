...
#SBATCH --output=logs_new/cf100_100_12_balanced/%x_%A-%a_%n-%t.out
#SBATCH --job-name=cf100_100_12_balanced
#SBATCH --qos=normal
...
echo ""
# Input handling
SAVE_PATH=~/vector_projects/outputs/seed_exp/cf100_100_12_balanced
DATASET="cifar100"
EPOCHS=100
RESNET_TYPE="$1"
SEED="$2"
