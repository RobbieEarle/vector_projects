...
#SBATCH --array=0-1                # array value (for running multiple seeds, etc)
#SBATCH --output=logs_new/il_exp2/%x_%A-%a_%n-%t.out
#SBATCH --job-name=cf10_100_balanced_il
#SBATCH --qos=normal
...
echo ""
# Input handling
SAVE_PATH=~/vector_projects/outputs/il_exp2/cf10_100_balanced
DATASET="cifar10"
EPOCHS=100
RESNET_TYPE="$1"
SEED="$2"
