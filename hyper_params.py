...
def nn_mnist(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.81, -4.23)),
            "adam_beta_2": np.exp(rng.uniform(-7.83, -5.66)),
            "adam_eps": np.exp(rng.uniform(-20.42, -18.93)),
            "adam_wd": np.exp(rng.uniform(-13.44, -13.02)),
            "max_lr": np.exp(rng.uniform(-8.0, -7.67)),
            "cycle_peak": rng.uniform(0.38, 0.4),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-2.63, -2.27)),
            "adam_beta_2": np.exp(rng.uniform(-6.12, -4.65)),
            "adam_eps": np.exp(rng.uniform(-20.5, -16.58)),
            "adam_wd": np.exp(rng.uniform(-10.49, -9.64)),
            "max_lr": np.exp(rng.uniform(-7.77, -7.28)),
            "cycle_peak": rng.uniform(0.4, 0.52),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-3.67, -3.28)),
            "adam_beta_2": np.exp(rng.uniform(-10.11, -7.3)),
            "adam_eps": np.exp(rng.uniform(-18.83, -17.96)),
            "adam_wd": np.exp(rng.uniform(-11.97, -10.25)),
            "max_lr": np.exp(rng.uniform(-7.86, -7.07)),
            "cycle_peak": rng.uniform(0.17, 0.24),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-5.26, -3.54)),
            "adam_beta_2": np.exp(rng.uniform(-10.97, -5.98)),
            "adam_eps": np.exp(rng.uniform(-15.21, -14.99)),
            "adam_wd": np.exp(rng.uniform(-13.05, -11.31)),
            "max_lr": np.exp(rng.uniform(-6.39, -5.67)),
            "cycle_peak": rng.uniform(0.34, 0.49),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-4.0, -3.68)),
            "adam_beta_2": np.exp(rng.uniform(-9.28, -7.21)),
            "adam_eps": np.exp(rng.uniform(-18.51, -17.81)),
            "adam_wd": np.exp(rng.uniform(-10.06, -9.09)),
            "max_lr": np.exp(rng.uniform(-6.38, -6.2)),
...
def nn_cifar10(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.72, -4.09)),
            "adam_beta_2": np.exp(rng.uniform(-5.31, -2.91)),
            "adam_eps": np.exp(rng.uniform(-18.52, -17.73)),
            "adam_wd": np.exp(rng.uniform(-11.91, -9.18)),
            "max_lr": np.exp(rng.uniform(-7.33, -5.94)),
            "cycle_peak": rng.uniform(0.4, 0.42),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-4.49, -3.89)),
            "adam_beta_2": np.exp(rng.uniform(-7.53, -5.46)),
            "adam_eps": np.exp(rng.uniform(-20.24, -19.11)),
            "adam_wd": np.exp(rng.uniform(-10.15, -9.2)),
            "max_lr": np.exp(rng.uniform(-7.26, -7.07)),
            "cycle_peak": rng.uniform(0.46, 0.56),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.59, -3.23)),
            "adam_beta_2": np.exp(rng.uniform(-11.47, -4.17)),
            "adam_eps": np.exp(rng.uniform(-18.93, -16.61)),
            "adam_wd": np.exp(rng.uniform(-14.02, -13.43)),
            "max_lr": np.exp(rng.uniform(-7.3, -5.5)),
            "cycle_peak": rng.uniform(0.29, 0.31),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-5.02, -4.05)),
            "adam_beta_2": np.exp(rng.uniform(-6.5, -3.28)),
            "adam_eps": np.exp(rng.uniform(-20.52, -18.96)),
            "adam_wd": np.exp(rng.uniform(-10.97, -7.85)),
            "max_lr": np.exp(rng.uniform(-7.52, -6.47)),
            "cycle_peak": rng.uniform(0.33, 0.42),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-3.09, -2.66)),
            "adam_beta_2": np.exp(rng.uniform(-6.49, -5.44)),
            "adam_eps": np.exp(rng.uniform(-18.65, -15.36)),
            "adam_wd": np.exp(rng.uniform(-10.48, -9.83)),
            "max_lr": np.exp(rng.uniform(-6.01, -5.38)),
            "cycle_peak": rng.uniform(0.3, 0.51),
        },
        "groupsort": {"adam_beta_1": np.exp(rng.uniform(-5, 0)),
                      "adam_beta_2": np.exp(rng.uniform(-12, -4)),
                      "adam_eps": np.exp(rng.uniform(-22, -15)),
...
def nn_cifar100(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.11, -3.72)),
            "adam_beta_2": np.exp(rng.uniform(-2.63, -2.23)),
            "adam_eps": np.exp(rng.uniform(-18.83, -17.75)),
            "adam_wd": np.exp(rng.uniform(-10.54, -9.53)),
            "max_lr": np.exp(rng.uniform(-7.76, -6.68)),
            "cycle_peak": rng.uniform(0.3, 0.35),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.01, -0.73)),
            "adam_beta_2": np.exp(rng.uniform(-4.55, -4.05)),
            "adam_eps": np.exp(rng.uniform(-20.75, -14.91)),
            "adam_wd": np.exp(rng.uniform(-14.38, -13.31)),
            "max_lr": np.exp(rng.uniform(-7.44, -6.76)),
            "cycle_peak": rng.uniform(0.31, 0.51),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-2.51, -2.35)),
            "adam_beta_2": np.exp(rng.uniform(-8.22, -7.54)),
            "adam_eps": np.exp(rng.uniform(-18.45, -17.73)),
            "adam_wd": np.exp(rng.uniform(-12.43, -9.89)),
            "max_lr": np.exp(rng.uniform(-9.09, -4.93)),
            "cycle_peak": rng.uniform(0.25, 0.31),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.11, -0.64)),
            "adam_beta_2": np.exp(rng.uniform(-5.89, -5.69)),
            "adam_eps": np.exp(rng.uniform(-20.61, -19.29)),
            "adam_wd": np.exp(rng.uniform(-12.29, -11.53)),
            "max_lr": np.exp(rng.uniform(-8.59, -8.17)),
            "cycle_peak": rng.uniform(0.31, 0.41),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-0.36, -0.08)),
            "adam_beta_2": np.exp(rng.uniform(-7.16, -6.66)),
            "adam_eps": np.exp(rng.uniform(-20.54, -18.65)),
            "adam_wd": np.exp(rng.uniform(-15.82, -12.48)),
            "max_lr": np.exp(rng.uniform(-8.01, -7.7)),
            "cycle_peak": rng.uniform(0.43, 0.48),
        },
        "groupsort": {"adam_beta_1": np.exp(rng.uniform(-5, 0)),
                      "adam_beta_2": np.exp(rng.uniform(-12, -4)),
                      "adam_eps": np.exp(rng.uniform(-22, -15)),
...
def cnn_mnist(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.48, -4.31)),
            "adam_beta_2": np.exp(rng.uniform(-9.31, -8.88)),
            "adam_eps": np.exp(rng.uniform(-18.47, -17.4)),
            "adam_wd": np.exp(rng.uniform(-13.85, -13.45)),
            "max_lr": np.exp(rng.uniform(-7.17, -6.96)),
            "cycle_peak": rng.uniform(0.24, 0.45),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-4.18, -3.8)),
            "adam_beta_2": np.exp(rng.uniform(-8.34, -6.4)),
            "adam_eps": np.exp(rng.uniform(-16.88, -15.52)),
            "adam_wd": np.exp(rng.uniform(-12.64, -11.99)),
            "max_lr": np.exp(rng.uniform(-7.25, -6.61)),
            "cycle_peak": rng.uniform(0.2, 0.27),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-3.66, -3.37)),
            "adam_beta_2": np.exp(rng.uniform(-7.61, -5.92)),
            "adam_eps": np.exp(rng.uniform(-19.92, -19.28)),
            "adam_wd": np.exp(rng.uniform(-12.87, -10.75)),
            "max_lr": np.exp(rng.uniform(-7.75, -7.41)),
            "cycle_peak": rng.uniform(0.29, 0.36),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-3.66, -3.07)),
            "adam_beta_2": np.exp(rng.uniform(-7.37, -6.07)),
            "adam_eps": np.exp(rng.uniform(-16.29, -15.0)),
            "adam_wd": np.exp(rng.uniform(-13.69, -12.19)),
            "max_lr": np.exp(rng.uniform(-7.63, -6.98)),
            "cycle_peak": rng.uniform(0.33, 0.4),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-4.25, -4.07)),
            "adam_beta_2": np.exp(rng.uniform(-10.35, -7.48)),
            "adam_eps": np.exp(rng.uniform(-18.5, -16.85)),
            "adam_wd": np.exp(rng.uniform(-13.04, -10.91)),
            "max_lr": np.exp(rng.uniform(-7.75, -6.8)),
...
def cnn_cifar10(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.23, -4.04)),
            "adam_beta_2": np.exp(rng.uniform(-5.62, -4.83)),
            "adam_eps": np.exp(rng.uniform(-17.57, -16.38)),
            "adam_wd": np.exp(rng.uniform(-7.77, -6.91)),
            "max_lr": np.exp(rng.uniform(-7.17, -6.81)),
            "cycle_peak": rng.uniform(0.3, 0.35),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-3.8, -2.51)),
            "adam_beta_2": np.exp(rng.uniform(-6.67, -5.32)),
            "adam_eps": np.exp(rng.uniform(-19.94, -14.92)),
            "adam_wd": np.exp(rng.uniform(-7.67, -7.28)),
            "max_lr": np.exp(rng.uniform(-7.01, -6.87)),
            "cycle_peak": rng.uniform(0.37, 0.45),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.22, -3.19)),
            "adam_beta_2": np.exp(rng.uniform(-7.76, -3.7)),
            "adam_eps": np.exp(rng.uniform(-18.34, -18.13)),
            "adam_wd": np.exp(rng.uniform(-10.05, -8.08)),
            "max_lr": np.exp(rng.uniform(-6.76, -6.61)),
            "cycle_peak": rng.uniform(0.28, 0.33),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.87, -1.61)),
            "adam_beta_2": np.exp(rng.uniform(-5.13, -4.42)),
            "adam_eps": np.exp(rng.uniform(-20.45, -18.21)),
            "adam_wd": np.exp(rng.uniform(-15.3, -13.18)),
            "max_lr": np.exp(rng.uniform(-6.85, -6.44)),
            "cycle_peak": rng.uniform(0.3, 0.44),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-2.11, -0.85)),
            "adam_beta_2": np.exp(rng.uniform(-5.53, -4.72)),
            "adam_eps": np.exp(rng.uniform(-20.88, -19.05)),
            "adam_wd": np.exp(rng.uniform(-8.88, -8.46)),
            "max_lr": np.exp(rng.uniform(-6.83, -6.11)),
...
def cnn_cifar100(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.66, -4.44)),
            "adam_beta_2": np.exp(rng.uniform(-2.92, -1.69)),
            "adam_eps": np.exp(rng.uniform(-17.94, -17.85)),
            "adam_wd": np.exp(rng.uniform(-14.99, -9.72)),
            "max_lr": np.exp(rng.uniform(-6.86, -6.79)),
            "cycle_peak": rng.uniform(0.24, 0.28),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.9, -1.05)),
            "adam_beta_2": np.exp(rng.uniform(-4.68, -3.32)),
            "adam_eps": np.exp(rng.uniform(-18.79, -17.16)),
            "adam_wd": np.exp(rng.uniform(-12.46, -10.38)),
            "max_lr": np.exp(rng.uniform(-7.47, -7.05)),
            "cycle_peak": rng.uniform(0.28, 0.62),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.05, -3.82)),
            "adam_beta_2": np.exp(rng.uniform(-4.44, -2.51)),
            "adam_eps": np.exp(rng.uniform(-18.53, -16.81)),
            "adam_wd": np.exp(rng.uniform(-13.26, -11.75)),
            "max_lr": np.exp(rng.uniform(-6.95, -6.89)),
            "cycle_peak": rng.uniform(0.26, 0.32),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.4, -1.35)),
            "adam_beta_2": np.exp(rng.uniform(-3.5, -3.06)),
            "adam_eps": np.exp(rng.uniform(-21.59, -18.48)),
            "adam_wd": np.exp(rng.uniform(-14.67, -13.42)),
            "max_lr": np.exp(rng.uniform(-7.07, -6.74)),
            "cycle_peak": rng.uniform(0.23, 0.36),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-1.7, -1.3)),
            "adam_beta_2": np.exp(rng.uniform(-7.64, -5.52)),
            "adam_eps": np.exp(rng.uniform(-17.64, -16.84)),
            "adam_wd": np.exp(rng.uniform(-7.74, -7.22)),
            "max_lr": np.exp(rng.uniform(-6.88, -6.73)),
            "cycle_peak": rng.uniform(0.42, 0.54),
        },
        "lse": {
