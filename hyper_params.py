...
def nn_cifar10(rng):
    return {
        ...
        "combinact": {
            "adam_beta_1": np.exp(rng.uniform(-1.62, -1.02)),
            "adam_beta_2": np.exp(rng.uniform(-4.82, -4.51)),
            "adam_eps": np.exp(rng.uniform(-17.8, -15.18)),
            "adam_wd": np.exp(rng.uniform(-14.08, -12.52)),
            "max_lr": np.exp(rng.uniform(-6.64, -5.98)),
            "cycle_peak": rng.uniform(0.36, 0.42),
        },
        "min": {
...
def nn_cifar100(rng):
    return {
        ...
        "combinact": {
            "adam_beta_1": np.exp(rng.uniform(-0.6, -0.44)),
            "adam_beta_2": np.exp(rng.uniform(-7.09, -5.68)),
            "adam_eps": np.exp(rng.uniform(-22.81, -22.57)),
            "adam_wd": np.exp(rng.uniform(-11.68, -11.21)),
            "max_lr": np.exp(rng.uniform(-6.23, -5.88)),
