...
def nn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-2.69, -1.01)),
            "adam_beta_2": np.exp(rng.uniform(-6.56, -5.44)),
            "adam_eps": np.exp(rng.uniform(-22.76, -15.43)),
            "adam_wd": np.exp(rng.uniform(-11.94, -9.86)),
            "max_lr": np.exp(rng.uniform(-6.98, -5.88)),
            "cycle_peak": rng.uniform(0.13, 0.32),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.68, -1.89)),
            "adam_beta_2": np.exp(rng.uniform(-8.63, -4.7)),
            "adam_eps": np.exp(rng.uniform(-19.11, -18.4)),
            "adam_wd": np.exp(rng.uniform(-9.79, -9.48)),
            "max_lr": np.exp(rng.uniform(-7.91, -7.18)),
            "cycle_peak": rng.uniform(0.33, 0.37),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-3.71, -2.86)),
            "adam_beta_2": np.exp(rng.uniform(-8.14, -4.38)),
            "adam_eps": np.exp(rng.uniform(-20.94, -19.97)),
            "adam_wd": np.exp(rng.uniform(-11.01, -8.78)),
            "max_lr": np.exp(rng.uniform(-6.12, -5.41)),
            "cycle_peak": rng.uniform(0.18, 0.44),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.96, -1.37)),
            "adam_beta_2": np.exp(rng.uniform(-9.0, -5.29)),
            "adam_eps": np.exp(rng.uniform(-18.82, -17.76)),
            "adam_wd": np.exp(rng.uniform(-13.28, -9.49)),
            "max_lr": np.exp(rng.uniform(-6.3, -5.59)),
            "cycle_peak": rng.uniform(0.3, 0.47),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.56, -1.47)),
            "adam_beta_2": np.exp(rng.uniform(-10.71, -5.34)),
            "adam_eps": np.exp(rng.uniform(-17.75, -16.09)),
            "adam_wd": np.exp(rng.uniform(-13.31, -10.96)),
            "max_lr": np.exp(rng.uniform(-6.0, -5.57)),
            "cycle_peak": rng.uniform(0.15, 0.3),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.49, -2.15)),
            "adam_beta_2": np.exp(rng.uniform(-10.41, -5.14)),
            "adam_eps": np.exp(rng.uniform(-18.51, -15.96)),
            "adam_wd": np.exp(rng.uniform(-12.33, -8.13)),
            "max_lr": np.exp(rng.uniform(-7.2, -5.65)),
            "cycle_peak": rng.uniform(0.3, 0.37),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.91, -1.82)),
            "adam_beta_2": np.exp(rng.uniform(-10.85, -4.99)),
            "adam_eps": np.exp(rng.uniform(-18.01, -16.27)),
            "adam_wd": np.exp(rng.uniform(-13.19, -6.42)),
            "max_lr": np.exp(rng.uniform(-7.13, -6.47)),
            "cycle_peak": rng.uniform(0.38, 0.47),
        },
...
def cnn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-5.12, -3.71)),
            "adam_beta_2": np.exp(rng.uniform(-6.79, -4.37)),
            "adam_eps": np.exp(rng.uniform(-20.31, -16.87)),
            "adam_wd": np.exp(rng.uniform(-15.34, -11.93)),
            "max_lr": np.exp(rng.uniform(-7.56, -6.11)),
            "cycle_peak": rng.uniform(0.14, 0.25),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.01, -3.18)),
            "adam_beta_2": np.exp(rng.uniform(-4.26, -3.38)),
            "adam_eps": np.exp(rng.uniform(-18.01, -14.76)),
            "adam_wd": np.exp(rng.uniform(-15.15, -12.96)),
            "max_lr": np.exp(rng.uniform(-7.66, -6.44)),
            "cycle_peak": rng.uniform(0.22, 0.31),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-5.04, -4.09)),
            "adam_beta_2": np.exp(rng.uniform(-9.93, -3.35)),
            "adam_eps": np.exp(rng.uniform(-20.74, -18.93)),
            "adam_wd": np.exp(rng.uniform(-11.72, -10.76)),
            "max_lr": np.exp(rng.uniform(-7.06, -6.0)),
            "cycle_peak": rng.uniform(0.07, 0.4),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-2.89, -2.27)),
            "adam_beta_2": np.exp(rng.uniform(-5.54, -4.49)),
            "adam_eps": np.exp(rng.uniform(-19.58, -15.62)),
            "adam_wd": np.exp(rng.uniform(-14.7, -13.25)),
            "max_lr": np.exp(rng.uniform(-6.78, -6.01)),
            "cycle_peak": rng.uniform(0.25, 0.43),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.06, -2.55)),
            "adam_beta_2": np.exp(rng.uniform(-9.75, -6.75)),
            "adam_eps": np.exp(rng.uniform(-21.07, -15.05)),
            "adam_wd": np.exp(rng.uniform(-12.32, -9.4)),
            "max_lr": np.exp(rng.uniform(-8.28, -7.84)),
            "cycle_peak": rng.uniform(0.16, 0.39),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.11, -3.08)),
            "adam_beta_2": np.exp(rng.uniform(-10.52, -7.05)),
            "adam_eps": np.exp(rng.uniform(-19.48, -18.62)),
            "adam_wd": np.exp(rng.uniform(-13.94, -12.65)),
            "max_lr": np.exp(rng.uniform(-7.79, -7.41)),
            "cycle_peak": rng.uniform(0.06, 0.43),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.68, -3.17)),
            "adam_beta_2": np.exp(rng.uniform(-8.3, -6.97)),
            "adam_eps": np.exp(rng.uniform(-17.91, -14.94)),
            "adam_wd": np.exp(rng.uniform(-12.86, -10.25)),
            "max_lr": np.exp(rng.uniform(-7.42, -6.81)),
            "cycle_peak": rng.uniform(0.34, 0.44),
        },
    }
