...
def nn_mnist(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-4.62, -1.23)),
            "adam_beta_2": np.exp(rng.uniform(-11.03, -4.34)),
            "adam_eps": np.exp(rng.uniform(-20.88, -16.36)),
            "adam_wd": np.exp(rng.uniform(-11.7, -9.44)),
            "max_lr": np.exp(rng.uniform(-7.29, -5.97)),
            "cycle_peak": rng.uniform(0.41, 0.51),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-3.52, -2.87)),
            "adam_beta_2": np.exp(rng.uniform(-11.66, -3.88)),
            "adam_eps": np.exp(rng.uniform(-20.32, -15.01)),
            "adam_wd": np.exp(rng.uniform(-11.12, -8.64)),
            "max_lr": np.exp(rng.uniform(-7.3, -5.46)),
            "cycle_peak": rng.uniform(0.17, 0.42),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-4.7, -3.39)),
            "adam_beta_2": np.exp(rng.uniform(-9.96, -4.06)),
            "adam_eps": np.exp(rng.uniform(-19.17, -16.42)),
            "adam_wd": np.exp(rng.uniform(-10.19, -8.31)),
            "max_lr": np.exp(rng.uniform(-8.01, -6.55)),
            "cycle_peak": rng.uniform(0.17, 0.42),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-3.72, -2.69)),
            "adam_beta_2": np.exp(rng.uniform(-7.43, -4.44)),
            "adam_eps": np.exp(rng.uniform(-19.37, -19.07)),
            "adam_wd": np.exp(rng.uniform(-10.11, -8.08)),
            "max_lr": np.exp(rng.uniform(-7.65, -5.6)),
            "cycle_peak": rng.uniform(0.37, 0.39),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-2.74, -1.71)),
            "adam_beta_2": np.exp(rng.uniform(-9.51, -6.73)),
            "adam_eps": np.exp(rng.uniform(-17.79, -16.01)),
            "adam_wd": np.exp(rng.uniform(-14.8, -10.46)),
            "max_lr": np.exp(rng.uniform(-8.07, -3.95)),
            "cycle_peak": rng.uniform(0.08, 0.32),
        },
...
def nn_cifar10(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-5.01, -2.23)),
            "adam_beta_2": np.exp(rng.uniform(-12.29, -8.75)),
            "adam_eps": np.exp(rng.uniform(-18.99, -17.06)),
            "adam_wd": np.exp(rng.uniform(-13.84, -7.61)),
            "max_lr": np.exp(rng.uniform(-6.81, -5.11)),
            "cycle_peak": rng.uniform(0.34, 0.46),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-3.27, -0.63)),
            "adam_beta_2": np.exp(rng.uniform(-6.86, -2.95)),
            "adam_eps": np.exp(rng.uniform(-20.17, -18.76)),
            "adam_wd": np.exp(rng.uniform(-12.95, -10.92)),
            "max_lr": np.exp(rng.uniform(-6.9, -5.88)),
            "cycle_peak": rng.uniform(0.22, 0.45),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-3.44, -2.86)),
            "adam_beta_2": np.exp(rng.uniform(-9.4, -3.66)),
            "adam_eps": np.exp(rng.uniform(-17.2, -15.03)),
            "adam_wd": np.exp(rng.uniform(-13.21, -10.7)),
            "max_lr": np.exp(rng.uniform(-4.85, -4.51)),
            "cycle_peak": rng.uniform(0.1, 0.45),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-4.88, -3.82)),
            "adam_beta_2": np.exp(rng.uniform(-13.38, -4.42)),
            "adam_eps": np.exp(rng.uniform(-18.52, -16.64)),
            "adam_wd": np.exp(rng.uniform(-13.8, -10.75)),
            "max_lr": np.exp(rng.uniform(-5.38, -4.9)),
            "cycle_peak": rng.uniform(0.39, 0.46),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-3.84, -1.75)),
            "adam_beta_2": np.exp(rng.uniform(-9.93, -4.63)),
            "adam_eps": np.exp(rng.uniform(-23.1, -16.94)),
            "adam_wd": np.exp(rng.uniform(-13.07, -7.66)),
            "max_lr": np.exp(rng.uniform(-7.54, -5.47)),
            "cycle_peak": rng.uniform(0.38, 0.46),
        },
    }
...
def nn_cifar100(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-0.72, 0.07)),
            "adam_beta_2": np.exp(rng.uniform(-4.95, -4.12)),
            "adam_eps": np.exp(rng.uniform(-18.67, -16.89)),
            "adam_wd": np.exp(rng.uniform(-14.57, -8.75)),
            "max_lr": np.exp(rng.uniform(-6.85, -5.72)),
            "cycle_peak": rng.uniform(0.26, 0.39),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-0.65, -0.36)),
            "adam_beta_2": np.exp(rng.uniform(-6.15, -4.09)),
            "adam_eps": np.exp(rng.uniform(-20.16, -17.92)),
            "adam_wd": np.exp(rng.uniform(-13.83, -11.44)),
            "max_lr": np.exp(rng.uniform(-7.64, -5.98)),
            "cycle_peak": rng.uniform(0.27, 0.47),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-1.49, -1.32)),
            "adam_beta_2": np.exp(rng.uniform(-5.88, -3.77)),
            "adam_eps": np.exp(rng.uniform(-17.78, -16.91)),
            "adam_wd": np.exp(rng.uniform(-15.93, -11.6)),
            "max_lr": np.exp(rng.uniform(-6.07, -5.01)),
            "cycle_peak": rng.uniform(0.15, 0.27),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-2.41, -1.62)),
            "adam_beta_2": np.exp(rng.uniform(-9.89, -5.02)),
            "adam_eps": np.exp(rng.uniform(-21.2, -16.96)),
            "adam_wd": np.exp(rng.uniform(-11.37, -10.06)),
            "max_lr": np.exp(rng.uniform(-5.67, -5.27)),
            "cycle_peak": rng.uniform(0.32, 0.38),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-0.77, -0.2)),
            "adam_beta_2": np.exp(rng.uniform(-7.21, -5.74)),
            "adam_eps": np.exp(rng.uniform(-23.17, -17.79)),
            "adam_wd": np.exp(rng.uniform(-10.37, -9.91)),
            "max_lr": np.exp(rng.uniform(-7.3, -6.81)),
            "cycle_peak": rng.uniform(0.31, 0.34),
        },
    }
...
def nn_fashion_mnist(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-3.37, -1.76)),
            "adam_beta_2": np.exp(rng.uniform(-11.48, -7.33)),
            "adam_eps": np.exp(rng.uniform(-21.18, -19.89)),
            "adam_wd": np.exp(rng.uniform(-14.9, -10.28)),
            "max_lr": np.exp(rng.uniform(-8.22, -6.09)),
            "cycle_peak": rng.uniform(0.23, 0.44),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-2.1, -1.54)),
            "adam_beta_2": np.exp(rng.uniform(-8.49, -6.61)),
            "adam_eps": np.exp(rng.uniform(-19.04, -15.71)),
            "adam_wd": np.exp(rng.uniform(-13.73, -10.78)),
            "max_lr": np.exp(rng.uniform(-5.92, -5.46)),
            "cycle_peak": rng.uniform(0.37, 0.46),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-4.43, -3.4)),
            "adam_beta_2": np.exp(rng.uniform(-11.46, -7.36)),
            "adam_eps": np.exp(rng.uniform(-17.76, -15.51)),
            "adam_wd": np.exp(rng.uniform(-13.69, -10.39)),
            "max_lr": np.exp(rng.uniform(-7.96, -6.39)),
            "cycle_peak": rng.uniform(0.19, 0.41),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-3.21, -2.7)),
            "adam_beta_2": np.exp(rng.uniform(-10.84, -4.34)),
            "adam_eps": np.exp(rng.uniform(-18.6, -17.65)),
            "adam_wd": np.exp(rng.uniform(-12.78, -10.14)),
            "max_lr": np.exp(rng.uniform(-7.76, -6.58)),
            "cycle_peak": rng.uniform(0.19, 0.44),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-1.22, -0.76)),
            "adam_beta_2": np.exp(rng.uniform(-10.23, -7.24)),
            "adam_eps": np.exp(rng.uniform(-17.02, -14.12)),
            "adam_wd": np.exp(rng.uniform(-15.0, -11.68)),
            "max_lr": np.exp(rng.uniform(-7.72, -6.28)),
            "cycle_peak": rng.uniform(0.36, 0.51),
        },
    }
...
def nn_svhn(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-5.03, -2.12)),
            "adam_beta_2": np.exp(rng.uniform(-11.4, -4.45)),
            "adam_eps": np.exp(rng.uniform(-20.08, -14.77)),
            "adam_wd": np.exp(rng.uniform(-12.95, -10.81)),
            "max_lr": np.exp(rng.uniform(-5.97, -5.45)),
            "cycle_peak": rng.uniform(0.28, 0.33),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-2.75, -2.25)),
            "adam_beta_2": np.exp(rng.uniform(-8.98, -5.99)),
            "adam_eps": np.exp(rng.uniform(-18.75, -17.3)),
            "adam_wd": np.exp(rng.uniform(-14.62, -10.79)),
            "max_lr": np.exp(rng.uniform(-5.91, -5.38)),
            "cycle_peak": rng.uniform(0.33, 0.5),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-5.36, -3.15)),
            "adam_beta_2": np.exp(rng.uniform(-13.06, -5.62)),
            "adam_eps": np.exp(rng.uniform(-16.88, -15.32)),
            "adam_wd": np.exp(rng.uniform(-13.71, -12.48)),
            "max_lr": np.exp(rng.uniform(-7.58, -6.06)),
            "cycle_peak": rng.uniform(0.24, 0.41),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-3.27, -2.73)),
            "adam_beta_2": np.exp(rng.uniform(-8.07, -3.09)),
            "adam_eps": np.exp(rng.uniform(-19.1, -16.04)),
            "adam_wd": np.exp(rng.uniform(-13.69, -10.64)),
            "max_lr": np.exp(rng.uniform(-6.97, -5.48)),
            "cycle_peak": rng.uniform(0.34, 0.38),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-2.72, -1.48)),
            "adam_beta_2": np.exp(rng.uniform(-8.22, -5.2)),
            "adam_eps": np.exp(rng.uniform(-21.24, -15.68)),
            "adam_wd": np.exp(rng.uniform(-15.83, -11.22)),
            "max_lr": np.exp(rng.uniform(-7.02, -5.5)),
            "cycle_peak": rng.uniform(0.37, 0.52),
        },
    }
...
def cnn_mnist(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-3.15, -2.42)),
            "adam_beta_2": np.exp(rng.uniform(-9.97, -5.87)),
            "adam_eps": np.exp(rng.uniform(-18.16, -14.35)),
            "adam_wd": np.exp(rng.uniform(-14.97, -12.56)),
            "max_lr": np.exp(rng.uniform(-6.12, -4.8)),
            "cycle_peak": rng.uniform(0.26, 0.52),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-4.93, -4.12)),
            "adam_beta_2": np.exp(rng.uniform(-9.91, -3.5)),
            "adam_eps": np.exp(rng.uniform(-21.33, -18.83)),
            "adam_wd": np.exp(rng.uniform(-13.97, -11.88)),
            "max_lr": np.exp(rng.uniform(-7.1, -4.55)),
            "cycle_peak": rng.uniform(0.27, 0.52),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-4.71, -3.6)),
            "adam_beta_2": np.exp(rng.uniform(-10.6, -4.93)),
            "adam_eps": np.exp(rng.uniform(-19.66, -16.87)),
            "adam_wd": np.exp(rng.uniform(-12.22, -8.14)),
            "max_lr": np.exp(rng.uniform(-7.75, -6.3)),
            "cycle_peak": rng.uniform(0.32, 0.36),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-5.5, -4.31)),
            "adam_beta_2": np.exp(rng.uniform(-8.37, -4.47)),
            "adam_eps": np.exp(rng.uniform(-18.84, -15.95)),
            "adam_wd": np.exp(rng.uniform(-12.94, -9.39)),
            "max_lr": np.exp(rng.uniform(-7.63, -5.97)),
            "cycle_peak": rng.uniform(0.2, 0.31),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-2.38, -1.61)),
            "adam_beta_2": np.exp(rng.uniform(-9.51, -4.94)),
            "adam_eps": np.exp(rng.uniform(-19.76, -17.33)),
            "adam_wd": np.exp(rng.uniform(-12.24, -10.17)),
            "max_lr": np.exp(rng.uniform(-7.49, -6.23)),
            "cycle_peak": rng.uniform(0.17, 0.38),
        },
    }
...
def cnn_cifar10(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-4.16, -2.88)),
            "adam_beta_2": np.exp(rng.uniform(-7.69, -5.99)),
            "adam_eps": np.exp(rng.uniform(-21.5, -18.53)),
            "adam_wd": np.exp(rng.uniform(-13.21, -10.06)),
            "max_lr": np.exp(rng.uniform(-6.07, -4.69)),
            "cycle_peak": rng.uniform(0.12, 0.48),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-3.78, -2.05)),
            "adam_beta_2": np.exp(rng.uniform(-8.71, -4.39)),
            "adam_eps": np.exp(rng.uniform(-21.96, -21.66)),
            "adam_wd": np.exp(rng.uniform(-8.63, -8.32)),
            "max_lr": np.exp(rng.uniform(-7.25, -5.66)),
            "cycle_peak": rng.uniform(0.2, 0.27),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-4.58, -2.76)),
            "adam_beta_2": np.exp(rng.uniform(-8.12, -3.92)),
            "adam_eps": np.exp(rng.uniform(-21.11, -18.39)),
            "adam_wd": np.exp(rng.uniform(-12.21, -7.34)),
            "max_lr": np.exp(rng.uniform(-7.57, -7.04)),
            "cycle_peak": rng.uniform(0.32, 0.41),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-5.25, -3.47)),
            "adam_beta_2": np.exp(rng.uniform(-10.22, -4.18)),
            "adam_eps": np.exp(rng.uniform(-17.96, -15.83)),
            "adam_wd": np.exp(rng.uniform(-10.93, -7.64)),
            "max_lr": np.exp(rng.uniform(-7.65, -7.12)),
            "cycle_peak": rng.uniform(0.2, 0.29),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-1.66, -1.13)),
            "adam_beta_2": np.exp(rng.uniform(-7.06, -3.88)),
            "adam_eps": np.exp(rng.uniform(-19.15, -18.22)),
            "adam_wd": np.exp(rng.uniform(-12.0, -8.25)),
            "max_lr": np.exp(rng.uniform(-6.37, -5.9)),
            "cycle_peak": rng.uniform(0.36, 0.38),
        },
    }
...
def cnn_cifar100(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-4.87, -4.17)),
            "adam_beta_2": np.exp(rng.uniform(-7.85, -5.28)),
            "adam_eps": np.exp(rng.uniform(-20.7, -17.62)),
            "adam_wd": np.exp(rng.uniform(-14.11, -12.82)),
            "max_lr": np.exp(rng.uniform(-5.11, -5.01)),
            "cycle_peak": rng.uniform(0.14, 0.23),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-4.0, -2.97)),
            "adam_beta_2": np.exp(rng.uniform(-6.99, -4.16)),
            "adam_eps": np.exp(rng.uniform(-23.36, -19.8)),
            "adam_wd": np.exp(rng.uniform(-8.64, -8.26)),
            "max_lr": np.exp(rng.uniform(-6.13, -5.87)),
            "cycle_peak": rng.uniform(0.22, 0.28),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-4.74, -3.9)),
            "adam_beta_2": np.exp(rng.uniform(-11.26, -2.87)),
            "adam_eps": np.exp(rng.uniform(-20.23, -17.11)),
            "adam_wd": np.exp(rng.uniform(-8.5, -8.01)),
            "max_lr": np.exp(rng.uniform(-7.54, -6.98)),
            "cycle_peak": rng.uniform(0.29, 0.35),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-5.25, -3.53)),
            "adam_beta_2": np.exp(rng.uniform(-9.96, -6.88)),
            "adam_eps": np.exp(rng.uniform(-19.91, -17.05)),
            "adam_wd": np.exp(rng.uniform(-11.75, -8.45)),
            "max_lr": np.exp(rng.uniform(-8.03, -7.41)),
            "cycle_peak": rng.uniform(0.19, 0.36),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-4.57, -1.33)),
            "adam_beta_2": np.exp(rng.uniform(-9.3, -5.85)),
            "adam_eps": np.exp(rng.uniform(-19.34, -17.86)),
            "adam_wd": np.exp(rng.uniform(-9.65, -9.2)),
            "max_lr": np.exp(rng.uniform(-6.61, -6.0)),
            "cycle_peak": rng.uniform(0.41, 0.48),
        },
    }
...
def cnn_fashion_mnist(rng):
    return {
        ...
        "prod": {
            "adam_beta_1": np.exp(rng.uniform(-4.18, -3.21)),
            "adam_beta_2": np.exp(rng.uniform(-10.85, -3.98)),
            "adam_eps": np.exp(rng.uniform(-19.17, -16.32)),
            "adam_wd": np.exp(rng.uniform(-14.63, -9.69)),
            "max_lr": np.exp(rng.uniform(-5.7, -5.18)),
            "cycle_peak": rng.uniform(0.02, 0.31),
        },
        "lae": {
            "adam_beta_1": np.exp(rng.uniform(-4.57, -4.16)),
            "adam_beta_2": np.exp(rng.uniform(-10.38, -6.64)),
            "adam_eps": np.exp(rng.uniform(-22.37, -18.81)),
            "adam_wd": np.exp(rng.uniform(-13.22, -6.55)),
            "max_lr": np.exp(rng.uniform(-7.66, -6.55)),
            "cycle_peak": rng.uniform(0.22, 0.45),
        },
        "signed_geomean": {
            "adam_beta_1": np.exp(rng.uniform(-5.03, -2.8)),
            "adam_beta_2": np.exp(rng.uniform(-7.11, -4.12)),
            "adam_eps": np.exp(rng.uniform(-17.1, -15.51)),
            "adam_wd": np.exp(rng.uniform(-11.22, -6.38)),
            "max_lr": np.exp(rng.uniform(-7.5, -6.61)),
            "cycle_peak": rng.uniform(0.38, 0.42),
        },
        "linf": {
            "adam_beta_1": np.exp(rng.uniform(-3.11, -2.84)),
            "adam_beta_2": np.exp(rng.uniform(-8.49, -4.47)),
            "adam_eps": np.exp(rng.uniform(-18.78, -15.31)),
            "adam_wd": np.exp(rng.uniform(-10.72, -8.05)),
            "max_lr": np.exp(rng.uniform(-7.66, -6.29)),
            "cycle_peak": rng.uniform(0.32, 0.41),
        },
        "swishk": {
            "adam_beta_1": np.exp(rng.uniform(-2.4, -1.95)),
            "adam_beta_2": np.exp(rng.uniform(-10.26, -7.48)),
            "adam_eps": np.exp(rng.uniform(-16.1, -15.04)),
            "adam_wd": np.exp(rng.uniform(-11.95, -8.61)),
            "max_lr": np.exp(rng.uniform(-7.48, -5.83)),
