...
def nn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-0.43, -0.18)),
            "adam_beta_2": np.power(10., rng.uniform(-1.28, -0.86)),
            "adam_eps": np.power(10., rng.uniform(-9.57, -7.79)),
            "adam_wd": np.power(10., rng.uniform(-5.62, -4.97)),
            "max_lr": np.power(10., rng.uniform(-2.58, -2.39)),
            "cycle_peak": rng.uniform(0.25, 0.33),
        },
        "swish": {
            "adam_beta_1": np.power(10., rng.uniform(-0.28, -0.23)),
            "adam_beta_2": np.power(10., rng.uniform(-1.24, -0.18)),
            "adam_eps": np.power(10., rng.uniform(-9.13, -7.07)),
            "adam_wd": np.power(10., rng.uniform(-4.33, -4.14)),
            "max_lr": np.power(10., rng.uniform(-2.69, -2.32)),
            "cycle_peak": rng.uniform(0.26, 0.38),
        },
        "swishk_p_inv": {
            "adam_beta_1": np.power(10., rng.uniform(-2.18, -1.36)),
            "adam_beta_2": np.power(10., rng.uniform(-0.12, -0.01)),
            "adam_eps": np.power(10., rng.uniform(-9.72, -6.51)),
            "adam_wd": np.power(10., rng.uniform(-4.73, -3.17)),
            "max_lr": np.power(10., rng.uniform(-2.87, -2.33)),
...
def cnn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-1.05, -0.56)),
            "adam_beta_2": np.power(10., rng.uniform(-1.13, -0.5)),
            "adam_eps": np.power(10., rng.uniform(-9.48, -7.88)),
            "adam_wd": np.power(10., rng.uniform(-5.08, -4.67)),
            "max_lr": np.power(10., rng.uniform(-2.95, -2.79)),
            "cycle_peak": rng.uniform(0.38, 0.45),
        },
        "swish": {
            "adam_beta_1": np.power(10., rng.uniform(-1.39, -0.7)),
            "adam_beta_2": np.power(10., rng.uniform(-2.01, 0.0)),
            "adam_eps": np.power(10., rng.uniform(-8.25, -6.91)),
            "adam_wd": np.power(10., rng.uniform(-5.27, -4.7)),
            "max_lr": np.power(10., rng.uniform(-3.41, -3.28)),
            "cycle_peak": rng.uniform(0.27, 0.36),
        },
        "swishk_p_inv": {
            "adam_beta_1": np.power(10., rng.uniform(-1.37, -0.72)),
            "adam_beta_2": np.power(10., rng.uniform(-1.76, -1.23)),
            "adam_eps": np.power(10., rng.uniform(-8.64, -5.68)),
            "adam_wd": np.power(10., rng.uniform(-5.03, -4.84)),
            "max_lr": np.power(10., rng.uniform(-3.48, -2.88)),
            "cycle_peak": rng.uniform(0.25, 0.29),
        },
    }
...
def resnet_mnist(rng):
    return {
        "max": {
            "adam_beta_1": np.power(10., rng.uniform(-2.68, -2.08)),
            "adam_beta_2": np.power(10., rng.uniform(-2.77, -1.58)),
            "adam_eps": np.power(10., rng.uniform(-8.67, -4.22)),
            "adam_wd": np.power(10., rng.uniform(-5.71, -2.56)),
            "max_lr": np.power(10., rng.uniform(-5, -3.59)),
            "cycle_peak": rng.uniform(0.19, 0.46),
        },
        "relu": {
            "adam_beta_1": np.power(10., rng.uniform(-3.28, -0.6)),
            "adam_beta_2": np.power(10., rng.uniform(-2.35, 0.45)),
            "adam_eps": np.power(10., rng.uniform(-7.02, -6.6)),
            "adam_wd": np.power(10., rng.uniform(-5.46, -3.57)),
            "max_lr": np.power(10., rng.uniform(-4.87, -3.1)),
            "cycle_peak": rng.uniform(0.08, 0.3),
        },
...
def resnet_cifar10(rng):
    return {
        "max": {
            "adam_beta_1": np.power(10., rng.uniform(-2.47, -0.86)),
            "adam_beta_2": np.power(10., rng.uniform(-1.85, 0.16)),
            "adam_eps": np.power(10., rng.uniform(-9.67, -7.25)),
            "adam_wd": np.power(10., rng.uniform(-5.97, -3.89)),
            "max_lr": np.power(10., rng.uniform(-3.39, -2.79)),
            "cycle_peak": rng.uniform(0.04, 0.47),
        },
        "relu": {
            "adam_beta_1": np.power(10., rng.uniform(-3.01, -0.16)),
            "adam_beta_2": np.power(10., rng.uniform(-1.75, 0.09)),
            "adam_eps": np.power(10., rng.uniform(-8.36, -7.59)),
            "adam_wd": np.power(10., rng.uniform(-5.35, -3.51)),
            "max_lr": np.power(10., rng.uniform(-3.69, -3.09)),
            "cycle_peak": rng.uniform(0.16, 0.3),
        },
        "multi_relu": {"adam_beta_1": np.power(10., rng.uniform(-3, 0)),
                       "adam_beta_2": np.power(10., rng.uniform(-3, 0)),
                       "adam_eps": np.power(10., rng.uniform(-10, -6)),
...
def resnet_cifar100(rng):
    return {
        "max": {
            "adam_beta_1": np.power(10., rng.uniform(-2.51, -1.78)),
            "adam_beta_2": np.power(10., rng.uniform(-1.98, -0.62)),
            "adam_eps": np.power(10., rng.uniform(-8.75, -7.84)),
            "adam_wd": np.power(10., rng.uniform(-4.22, -3.84)),
            "max_lr": np.power(10., rng.uniform(-3.38, -3.16)),
            "cycle_peak": rng.uniform(0.27, 0.42),
        },
        "relu": {
            "adam_beta_1": np.power(10., rng.uniform(-2.01, -0.15)),
            "adam_beta_2": np.power(10., rng.uniform(-1.55, -0.4)),
            "adam_eps": np.power(10., rng.uniform(-9.22, -7.92)),
            "adam_wd": np.power(10., rng.uniform(-5.39, -3.62)),
            "max_lr": np.power(10., rng.uniform(-3.62, -3.49)),
