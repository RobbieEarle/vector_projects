...
def nn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-3.78, -0.85)),
            "adam_beta_2": np.exp(rng.uniform(-6.6, -4.99)),
            "adam_eps": np.exp(rng.uniform(-21.36, -17.64)),
            "adam_wd": np.exp(rng.uniform(-12.87, -10.6)),
            "max_lr": np.exp(rng.uniform(-7.88, -5.56)),
            "cycle_peak": rng.uniform(0.11, 0.32),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.38, -1.53)),
            "adam_beta_2": np.exp(rng.uniform(-6.74, -3.94)),
            "adam_eps": np.exp(rng.uniform(-18.94, -15.18)),
            "adam_wd": np.exp(rng.uniform(-13.59, -10.72)),
            "max_lr": np.exp(rng.uniform(-6.92, -5.94)),
            "cycle_peak": rng.uniform(0.36, 0.38),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-3.75, -3.01)),
            "adam_beta_2": np.exp(rng.uniform(-11.39, -4.73)),
            "adam_eps": np.exp(rng.uniform(-20.23, -17.34)),
            "adam_wd": np.exp(rng.uniform(-11.03, -8.49)),
            "max_lr": np.exp(rng.uniform(-6.56, -5.09)),
            "cycle_peak": rng.uniform(0.24, 0.29),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.08, -2.03)),
            "adam_beta_2": np.exp(rng.uniform(-5.33, -3.9)),
            "adam_eps": np.exp(rng.uniform(-21.57, -18.58)),
            "adam_wd": np.exp(rng.uniform(-12.95, -10.07)),
            "max_lr": np.exp(rng.uniform(-7.12, -5.22)),
            "cycle_peak": rng.uniform(0.12, 0.34),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.92, -3.68)),
            "adam_beta_2": np.exp(rng.uniform(-11.06, -10.2)),
            "adam_eps": np.exp(rng.uniform(-21.03, -14.5)),
            "adam_wd": np.exp(rng.uniform(-11.31, -9.71)),
            "max_lr": np.exp(rng.uniform(-6.56, -5.38)),
            "cycle_peak": rng.uniform(0.15, 0.26),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.39, -2.34)),
            "adam_beta_2": np.exp(rng.uniform(-12.04, -5.88)),
            "adam_eps": np.exp(rng.uniform(-22.21, -17.18)),
            "adam_wd": np.exp(rng.uniform(-14.33, -12.7)),
            "max_lr": np.exp(rng.uniform(-8.19, -5.87)),
            "cycle_peak": rng.uniform(0.15, 0.25),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.52, -2.64)),
            "adam_beta_2": np.exp(rng.uniform(-10.85, -4.18)),
            "adam_eps": np.exp(rng.uniform(-19.05, -16.4)),
            "adam_wd": np.exp(rng.uniform(-12.71, -5.47)),
            "max_lr": np.exp(rng.uniform(-7.32, -6.59)),
            "cycle_peak": rng.uniform(0.15, 0.3),
        },
...
def cnn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-3.64, -3.12)),
            "adam_beta_2": np.exp(rng.uniform(-9.6, -6.3)),
            "adam_eps": np.exp(rng.uniform(-19.25, -17.44)),
            "adam_wd": np.exp(rng.uniform(-11.82, -9.75)),
            "max_lr": np.exp(rng.uniform(-8.33, -7.15)),
            "cycle_peak": rng.uniform(0.21, 0.41),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.29, -3.49)),
            "adam_beta_2": np.exp(rng.uniform(-9.68, -8.94)),
            "adam_eps": np.exp(rng.uniform(-22.54, -17.97)),
            "adam_wd": np.exp(rng.uniform(-10.4, -8.32)),
            "max_lr": np.exp(rng.uniform(-7.56, -6.54)),
            "cycle_peak": rng.uniform(0.23, 0.33),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-4.56, -3.53)),
            "adam_beta_2": np.exp(rng.uniform(-9.81, -6.34)),
            "adam_eps": np.exp(rng.uniform(-23.48, -18.27)),
            "adam_wd": np.exp(rng.uniform(-10.65, -9.01)),
            "max_lr": np.exp(rng.uniform(-7.34, -7.09)),
            "cycle_peak": rng.uniform(0.01, 0.25),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-5.16, -2.98)),
            "adam_beta_2": np.exp(rng.uniform(-9.88, -5.34)),
            "adam_eps": np.exp(rng.uniform(-19.09, -16.52)),
            "adam_wd": np.exp(rng.uniform(-13.44, -10.65)),
            "max_lr": np.exp(rng.uniform(-7.84, -6.71)),
            "cycle_peak": rng.uniform(0.25, 0.4),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.61, -3.24)),
            "adam_beta_2": np.exp(rng.uniform(-10.01, -6.93)),
            "adam_eps": np.exp(rng.uniform(-21.79, -17.27)),
            "adam_wd": np.exp(rng.uniform(-11.36, -7.78)),
            "max_lr": np.exp(rng.uniform(-8.27, -6.52)),
            "cycle_peak": rng.uniform(0.11, 0.33),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.74, -3.08)),
            "adam_beta_2": np.exp(rng.uniform(-7.14, -6.28)),
            "adam_eps": np.exp(rng.uniform(-21.41, -17.98)),
            "adam_wd": np.exp(rng.uniform(-13.26, -9.63)),
            "max_lr": np.exp(rng.uniform(-8.45, -5.2)),
            "cycle_peak": rng.uniform(0.2, 0.25),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.94, -2.62)),
            "adam_beta_2": np.exp(rng.uniform(-7.12, -6.1)),
            "adam_eps": np.exp(rng.uniform(-19.59, -16.73)),
            "adam_wd": np.exp(rng.uniform(-10.58, -9.3)),
            "max_lr": np.exp(rng.uniform(-7.35, -6.99)),
            "cycle_peak": rng.uniform(0.22, 0.35),
        },
    }
