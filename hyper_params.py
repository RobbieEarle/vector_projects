...
def nn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-1.99, -1.06)),
            "adam_beta_2": np.exp(rng.uniform(-6.43, -5.91)),
            "adam_eps": np.exp(rng.uniform(-21.68, -15.1)),
            "adam_wd": np.exp(rng.uniform(-11.66, -10.49)),
            "max_lr": np.exp(rng.uniform(-6.99, -6.38)),
            "cycle_peak": rng.uniform(0.18, 0.26),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.85, -2.21)),
            "adam_beta_2": np.exp(rng.uniform(-7.29, -4.85)),
            "adam_eps": np.exp(rng.uniform(-18.95, -18.51)),
            "adam_wd": np.exp(rng.uniform(-9.79, -9.45)),
            "max_lr": np.exp(rng.uniform(-7.93, -7.62)),
            "cycle_peak": rng.uniform(0.33, 0.36),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-3.8, -3.35)),
            "adam_beta_2": np.exp(rng.uniform(-7.92, -4.01)),
            "adam_eps": np.exp(rng.uniform(-20.82, -19.84)),
            "adam_wd": np.exp(rng.uniform(-9.99, -9.02)),
            "max_lr": np.exp(rng.uniform(-5.97, -5.42)),
            "cycle_peak": rng.uniform(0.21, 0.44),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.54, -1.56)),
            "adam_beta_2": np.exp(rng.uniform(-7.11, -5.4)),
            "adam_eps": np.exp(rng.uniform(-18.8, -17.81)),
            "adam_wd": np.exp(rng.uniform(-13.47, -11.55)),
            "max_lr": np.exp(rng.uniform(-6.22, -5.68)),
            "cycle_peak": rng.uniform(0.32, 0.44),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.94, -3.0)),
            "adam_beta_2": np.exp(rng.uniform(-10.86, -9.55)),
            "adam_eps": np.exp(rng.uniform(-17.71, -16.22)),
            "adam_wd": np.exp(rng.uniform(-13.04, -10.72)),
            "max_lr": np.exp(rng.uniform(-6.01, -5.71)),
            "cycle_peak": rng.uniform(0.17, 0.27),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.3, -2.05)),
            "adam_beta_2": np.exp(rng.uniform(-8.81, -5.53)),
            "adam_eps": np.exp(rng.uniform(-18.65, -16.82)),
            "adam_wd": np.exp(rng.uniform(-11.48, -8.51)),
            "max_lr": np.exp(rng.uniform(-6.74, -5.88)),
            "cycle_peak": rng.uniform(0.31, 0.35),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.07, -1.68)),
            "adam_beta_2": np.exp(rng.uniform(-10.08, -4.73)),
            "adam_eps": np.exp(rng.uniform(-16.75, -16.31)),
            "adam_wd": np.exp(rng.uniform(-10.2, -8.04)),
            "max_lr": np.exp(rng.uniform(-7.06, -6.48)),
...
def cnn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-5.03, -4.18)),
            "adam_beta_2": np.exp(rng.uniform(-6.77, -5.29)),
            "adam_eps": np.exp(rng.uniform(-19.72, -17.77)),
            "adam_wd": np.exp(rng.uniform(-15.56, -13.48)),
            "max_lr": np.exp(rng.uniform(-7.26, -6.84)),
            "cycle_peak": rng.uniform(0.15, 0.23),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.89, -3.28)),
            "adam_beta_2": np.exp(rng.uniform(-4.18, -3.32)),
            "adam_eps": np.exp(rng.uniform(-16.97, -15.01)),
            "adam_wd": np.exp(rng.uniform(-14.75, -14.14)),
            "max_lr": np.exp(rng.uniform(-7.39, -6.72)),
            "cycle_peak": rng.uniform(0.26, 0.29),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-5.13, -4.4)),
            "adam_beta_2": np.exp(rng.uniform(-11.56, -4.78)),
            "adam_eps": np.exp(rng.uniform(-20.78, -19.04)),
            "adam_wd": np.exp(rng.uniform(-11.3, -10.66)),
            "max_lr": np.exp(rng.uniform(-6.69, -6.0)),
            "cycle_peak": rng.uniform(0.15, 0.22),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-2.84, -2.28)),
            "adam_beta_2": np.exp(rng.uniform(-5.61, -4.65)),
            "adam_eps": np.exp(rng.uniform(-19.16, -17.03)),
            "adam_wd": np.exp(rng.uniform(-14.37, -13.81)),
            "max_lr": np.exp(rng.uniform(-6.67, -6.17)),
            "cycle_peak": rng.uniform(0.23, 0.38),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.83, -2.29)),
            "adam_beta_2": np.exp(rng.uniform(-9.67, -6.7)),
            "adam_eps": np.exp(rng.uniform(-20.03, -15.9)),
            "adam_wd": np.exp(rng.uniform(-10.76, -9.67)),
            "max_lr": np.exp(rng.uniform(-8.24, -7.82)),
            "cycle_peak": rng.uniform(0.14, 0.26),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.11, -3.4)),
            "adam_beta_2": np.exp(rng.uniform(-9.76, -7.23)),
            "adam_eps": np.exp(rng.uniform(-19.42, -18.34)),
            "adam_wd": np.exp(rng.uniform(-13.94, -12.51)),
            "max_lr": np.exp(rng.uniform(-7.72, -7.42)),
            "cycle_peak": rng.uniform(0.11, 0.36),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.48, -3.27)),
            "adam_beta_2": np.exp(rng.uniform(-8.23, -7.14)),
            "adam_eps": np.exp(rng.uniform(-16.24, -15.64)),
            "adam_wd": np.exp(rng.uniform(-13.08, -10.22)),
            "max_lr": np.exp(rng.uniform(-7.31, -7.05)),
