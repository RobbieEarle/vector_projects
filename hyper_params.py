...
def nn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.power(10., -0.605),
            "adam_beta_2": np.power(10., -2.584),
            "adam_eps": np.power(10., -6.876),
            "adam_wd": np.power(10., -4.736),
            "max_lr": np.power(10., -2.957),
            "cycle_peak": 0.23,
        },
        "ail_xnor": {
            "adam_beta_1": np.power(10., -1.017),
            "adam_beta_2": np.power(10., -2.897),
            "adam_eps": np.power(10., -8.184),
            "adam_wd": np.power(10., -4.117),
            "max_lr": np.power(10., -3.339),
            "cycle_peak": 0.34,
        },
        "ail_all_or_and": {
            "adam_beta_1": np.power(10., -1.59),
            "adam_beta_2": np.power(10., -1.767),
            "adam_eps": np.power(10., -8.994),
            "adam_wd": np.power(10., -3.93),
            "max_lr": np.power(10., -2.384),
            "cycle_peak": 0.43,
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.power(10., -1.298),
            "adam_beta_2": np.power(10., -2.75),
            "adam_eps": np.power(10., -8.076),
            "adam_wd": np.power(10., -5.682),
            "max_lr": np.power(10., -2.581),
            "cycle_peak": 0.33,
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.power(10., -1.351),
            "adam_beta_2": np.power(10., -4.345),
            "adam_eps": np.power(10., -7.664),
            "adam_wd": np.power(10., -5.028),
            "max_lr": np.power(10., -2.517),
            "cycle_peak": 0.22,
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.power(10., -0.942),
            "adam_beta_2": np.power(10., -3.249),
            "adam_eps": np.power(10., -7.836),
            "adam_wd": np.power(10., -4.248),
            "max_lr": np.power(10., -2.611),
            "cycle_peak": 0.34,
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.power(10., -0.848),
            "adam_beta_2": np.power(10., -3.245),
            "adam_eps": np.power(10., -7.129),
            "adam_wd": np.power(10., -3.871),
            "max_lr": np.power(10., -2.947),
            "cycle_peak": 0.39,
        },
...
def cnn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.power(10., -2.161),
            "adam_beta_2": np.power(10., -2.497),
            "adam_eps": np.power(10., -8.097),
            "adam_wd": np.power(10., -6.257),
            "max_lr": np.power(10., -3.09),
            "cycle_peak": 0.16,
        },
        "ail_xnor": {
            "adam_beta_1": np.power(10., -1.627),
            "adam_beta_2": np.power(10., -1.618),
            "adam_eps": np.power(10., -7.283),
            "adam_wd": np.power(10., -6.366),
            "max_lr": np.power(10., -2.933),
            "cycle_peak": 0.29,
        },
        "ail_all_or_and": {
            "adam_beta_1": np.power(10., -1.959),
            "adam_beta_2": np.power(10., -4.507),
            "adam_eps": np.power(10., -8.82),
            "adam_wd": np.power(10., -4.651),
            "max_lr": np.power(10., -2.711),
            "cycle_peak": 0.17,
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.power(10., -1.055),
            "adam_beta_2": np.power(10., -2.321),
            "adam_eps": np.power(10., -8.097),
            "adam_wd": np.power(10., -6.175),
            "max_lr": np.power(10., -2.861),
            "cycle_peak": 0.24,
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.power(10., -1.376),
            "adam_beta_2": np.power(10., -3.917),
            "adam_eps": np.power(10., -7.2),
            "adam_wd": np.power(10., -4.67),
            "max_lr": np.power(10., -3.552),
            "cycle_peak": 0.22,
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.power(10., -1.711),
            "adam_beta_2": np.power(10., -4.132),
            "adam_eps": np.power(10., -8.147),
            "adam_wd": np.power(10., -5.732),
            "max_lr": np.power(10., -3.292),
            "cycle_peak": 0.32,
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.power(10., -1.439),
            "adam_beta_2": np.power(10., -3.211),
            "adam_eps": np.power(10., -6.826),
            "adam_wd": np.power(10., -4.543),
            "max_lr": np.power(10., -3.144),
            "cycle_peak": 0.36,
        },
    }
