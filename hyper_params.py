...
def nn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-2.53, -1.08)),
            "adam_beta_2": np.exp(rng.uniform(-7.53, -5.43)),
            "adam_eps": np.exp(rng.uniform(-22.73, -15.29)),
            "adam_wd": np.exp(rng.uniform(-12.15, -10.21)),
            "max_lr": np.exp(rng.uniform(-8.05, -5.24)),
            "cycle_peak": rng.uniform(0.08, 0.38),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.47, 0.55)),
            "adam_beta_2": np.exp(rng.uniform(-9.26, -2.99)),
            "adam_eps": np.exp(rng.uniform(-21.18, -13.95)),
            "adam_wd": np.exp(rng.uniform(-9.87, -8.45)),
            "max_lr": np.exp(rng.uniform(-7.99, -6.5)),
            "cycle_peak": rng.uniform(0.29, 0.38),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-4.16, -0.81)),
            "adam_beta_2": np.exp(rng.uniform(-9.93, -4.06)),
            "adam_eps": np.exp(rng.uniform(-21.4, -14.47)),
            "adam_wd": np.exp(rng.uniform(-12.79, -6.73)),
            "max_lr": np.exp(rng.uniform(-6.7, -5.41)),
            "cycle_peak": rng.uniform(0.1, 0.47),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.97, -0.36)),
            "adam_beta_2": np.exp(rng.uniform(-9.12, -3.55)),
            "adam_eps": np.exp(rng.uniform(-21.35, -15.69)),
            "adam_wd": np.exp(rng.uniform(-13.57, -9.63)),
            "max_lr": np.exp(rng.uniform(-6.98, -5.51)),
            "cycle_peak": rng.uniform(0.18, 0.5),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.82, -0.29)),
            "adam_beta_2": np.exp(rng.uniform(-12.91, -3.1)),
            "adam_eps": np.exp(rng.uniform(-21.47, -15.05)),
            "adam_wd": np.exp(rng.uniform(-14.04, -10.11)),
            "max_lr": np.exp(rng.uniform(-6.7, -5.2)),
            "cycle_peak": rng.uniform(0.12, 0.33),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.84, -1.43)),
            "adam_beta_2": np.exp(rng.uniform(-12.38, -4.68)),
            "adam_eps": np.exp(rng.uniform(-20.86, -14.48)),
            "adam_wd": np.exp(rng.uniform(-13.83, -8.35)),
            "max_lr": np.exp(rng.uniform(-8.12, -5.84)),
            "cycle_peak": rng.uniform(0.19, 0.43),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.14, -1.48)),
            "adam_beta_2": np.exp(rng.uniform(-11.42, -4.37)),
            "adam_eps": np.exp(rng.uniform(-18.56, -14.79)),
            "adam_wd": np.exp(rng.uniform(-14.74, -7.45)),
            "max_lr": np.exp(rng.uniform(-7.3, -5.66)),
            "cycle_peak": rng.uniform(0.35, 0.46),
        },
...
def cnn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-4.99, -2.98)),
            "adam_beta_2": np.exp(rng.uniform(-9.56, -4.39)),
            "adam_eps": np.exp(rng.uniform(-21.6, -15.48)),
            "adam_wd": np.exp(rng.uniform(-15.5, -9.75)),
            "max_lr": np.exp(rng.uniform(-7.44, -5.04)),
            "cycle_peak": rng.uniform(0.12, 0.33),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-5.05, -2.57)),
            "adam_beta_2": np.exp(rng.uniform(-7.07, -3.3)),
            "adam_eps": np.exp(rng.uniform(-18.9, -14.07)),
            "adam_wd": np.exp(rng.uniform(-16.21, -9.96)),
            "max_lr": np.exp(rng.uniform(-8.16, -6.1)),
            "cycle_peak": rng.uniform(0.1, 0.33),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-5.26, -2.52)),
            "adam_beta_2": np.exp(rng.uniform(-12.14, -3.99)),
            "adam_eps": np.exp(rng.uniform(-20.69, -16.77)),
            "adam_wd": np.exp(rng.uniform(-13.7, -7.28)),
            "max_lr": np.exp(rng.uniform(-7.5, -5.88)),
            "cycle_peak": rng.uniform(0.1, 0.38),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.06, -2.07)),
            "adam_beta_2": np.exp(rng.uniform(-5.82, -4.09)),
            "adam_eps": np.exp(rng.uniform(-19.16, -15.53)),
            "adam_wd": np.exp(rng.uniform(-15.39, -11.54)),
            "max_lr": np.exp(rng.uniform(-6.77, -5.59)),
            "cycle_peak": rng.uniform(0.26, 0.44),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-5.25, -2.32)),
            "adam_beta_2": np.exp(rng.uniform(-10.05, -6.88)),
            "adam_eps": np.exp(rng.uniform(-21.54, -15.33)),
            "adam_wd": np.exp(rng.uniform(-12.67, -7.96)),
            "max_lr": np.exp(rng.uniform(-8.2, -6.8)),
            "cycle_peak": rng.uniform(0.15, 0.44),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.48, -1.94)),
            "adam_beta_2": np.exp(rng.uniform(-10.32, -6.4)),
            "adam_eps": np.exp(rng.uniform(-21.52, -18.15)),
            "adam_wd": np.exp(rng.uniform(-14.75, -10.95)),
            "max_lr": np.exp(rng.uniform(-8.0, -7.39)),
            "cycle_peak": rng.uniform(0.11, 0.44),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.71, -2.9)),
            "adam_beta_2": np.exp(rng.uniform(-8.59, -5.25)),
            "adam_eps": np.exp(rng.uniform(-18.28, -15.22)),
            "adam_wd": np.exp(rng.uniform(-13.3, -9.47)),
            "max_lr": np.exp(rng.uniform(-7.56, -6.77)),
