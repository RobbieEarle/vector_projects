...
def nn_cifar10(rng):
    return {
        ...
        "combinact": {
            "adam_beta_1": np.exp(rng.uniform(-2.89, -0.63)),
            "adam_beta_2": np.exp(rng.uniform(-5.69, -4.52)),
            "adam_eps": np.exp(rng.uniform(-19.35, -15.44)),
            "adam_wd": np.exp(rng.uniform(-14.56, -11.01)),
            "max_lr": np.exp(rng.uniform(-7.92, -4.48)),
            "cycle_peak": rng.uniform(0.27, 0.45),
        },
        "min": {
...
def nn_cifar100(rng):
    return {
        ...
        "combinact": {
            "adam_beta_1": np.exp(rng.uniform(-0.71, -0.44)),
            "adam_beta_2": np.exp(rng.uniform(-7.05, -4.58)),
            "adam_eps": np.exp(rng.uniform(-22.92, -21.1)),
            "adam_wd": np.exp(rng.uniform(-12.28, -10.21)),
            "max_lr": np.exp(rng.uniform(-6.47, -5.35)),
