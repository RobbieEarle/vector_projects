...
def nn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-2.65, 0.37)),
            "adam_beta_2": np.power(10., rng.uniform(-2.31, -0.18)),
            "adam_eps": np.power(10., rng.uniform(-9.17, -6.74)),
            "adam_wd": np.power(10., rng.uniform(-6.12, -3.96)),
            "max_lr": np.power(10., rng.uniform(-2.98, -2.15)),
            "cycle_peak": rng.uniform(0.05, 0.37),
        },
        "swish": {
            "adam_beta_1": np.power(10., rng.uniform(-2.3, -0.25)),
            "adam_beta_2": np.power(10., rng.uniform(-1.6, 0.63)),
            "adam_eps": np.power(10., rng.uniform(-9.23, -5.35)),
            "adam_wd": np.power(10., rng.uniform(-4.86, -3.64)),
            "max_lr": np.power(10., rng.uniform(-3.64, -2.25)),
            "cycle_peak": rng.uniform(0.2, 0.43),
        },
        "swishk_p_inv": {
            "adam_beta_1": np.power(10., rng.uniform(-2.61, -1.05)),
            "adam_beta_2": np.power(10., rng.uniform(-1.64, 0.77)),
            "adam_eps": np.power(10., rng.uniform(-9.55, -6.76)),
            "adam_wd": np.power(10., rng.uniform(-5.45, -2.43)),
            "max_lr": np.power(10., rng.uniform(-3.34, -1.98)),
            "cycle_peak": rng.uniform(0.09, 0.52),
        },
...
def cnn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-1.77, 0.19)),
            "adam_beta_2": np.power(10., rng.uniform(-1.86, -0.09)),
            "adam_eps": np.power(10., rng.uniform(-9.96, -6.93)),
            "adam_wd": np.power(10., rng.uniform(-5.03, -3.41)),
            "max_lr": np.power(10., rng.uniform(-3.31, -2.68)),
            "cycle_peak": rng.uniform(0.25, 0.49),
        },
        "swish": {
            "adam_beta_1": np.power(10., rng.uniform(-1.82, -0.49)),
            "adam_beta_2": np.power(10., rng.uniform(-2.96, -0.41)),
            "adam_eps": np.power(10., rng.uniform(-9.03, -6.45)),
            "adam_wd": np.power(10., rng.uniform(-5.4, -3.5)),
            "max_lr": np.power(10., rng.uniform(-3.52, -3.04)),
            "cycle_peak": rng.uniform(0.03, 0.41),
        },
        "swishk_p_inv": {
            "adam_beta_1": np.power(10., rng.uniform(-1.36, -0.34)),
            "adam_beta_2": np.power(10., rng.uniform(-2.15, -1.28)),
            "adam_eps": np.power(10., rng.uniform(-9.37, -6.05)),
            "adam_wd": np.power(10., rng.uniform(-5.15, -4.29)),
            "max_lr": np.power(10., rng.uniform(-4.17, -1.98)),
