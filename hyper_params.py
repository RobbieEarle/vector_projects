...
def nn_cifar10(rng):
    return {
        ...
        "l2": {
            "adam_beta_1": np.exp(rng.uniform(-2.37, -1.17)),
            "adam_beta_2": np.exp(rng.uniform(-5.75, -4.68)),
            "adam_eps": np.exp(rng.uniform(-21.78, -17.83)),
            "adam_wd": np.exp(rng.uniform(-12.78, -9.73)),
            "max_lr": np.exp(rng.uniform(-5.77, -4.39)),
            "cycle_peak": rng.uniform(0.33, 0.39),
        },
        "max": {
            "adam_beta_1": np.exp(rng.uniform(-5.68, -3.69)),
            "adam_beta_2": np.exp(rng.uniform(-10.12, -9.08)),
            "adam_eps": np.exp(rng.uniform(-16.97, -13.62)),
            "adam_wd": np.exp(rng.uniform(-14.43, -8.03)),
            "max_lr": np.exp(rng.uniform(-7.82, -6.15)),
            "cycle_peak": rng.uniform(0.35, 0.43),
        },
        "relu": {
            "adam_beta_1": np.exp(rng.uniform(-3.11, -1.62)),
            "adam_beta_2": np.exp(rng.uniform(-7.1, -5.32)),
            "adam_eps": np.exp(rng.uniform(-22.42, -18.41)),
            "adam_wd": np.exp(rng.uniform(-11.7, -9.82)),
            "max_lr": np.exp(rng.uniform(-7.56, -7.01)),
            "cycle_peak": rng.uniform(0.3, 0.36),
        },
    }
...
def nn_cifar100(rng):
    return {
        ...
        "l2": {
            "adam_beta_1": np.exp(rng.uniform(-1.24, -1.1)),
            "adam_beta_2": np.exp(rng.uniform(-6.42, -5.64)),
            "adam_eps": np.exp(rng.uniform(-23.03, -18.59)),
            "adam_wd": np.exp(rng.uniform(-12.07, -11.24)),
            "max_lr": np.exp(rng.uniform(-5.69, -4.99)),
            "cycle_peak": rng.uniform(0.29, 0.52),
        },
        "max": {
            "adam_beta_1": np.exp(rng.uniform(-1.3, -1.04)),
            "adam_beta_2": np.exp(rng.uniform(-7.13, -5.7)),
            "adam_eps": np.exp(rng.uniform(-21.44, -15.77)),
            "adam_wd": np.exp(rng.uniform(-14.76, -8.66)),
            "max_lr": np.exp(rng.uniform(-7.45, -7.14)),
            "cycle_peak": rng.uniform(0.23, 0.28),
        },
        "relu": {
            "adam_beta_1": np.exp(rng.uniform(-3.23, -2.75)),
            "adam_beta_2": np.exp(rng.uniform(-9.95, -6.22)),
            "adam_eps": np.exp(rng.uniform(-22.89, -17.97)),
            "adam_wd": np.exp(rng.uniform(-10.08, -7.52)),
            "max_lr": np.exp(rng.uniform(-7.04, -6.85)),
            "cycle_peak": rng.uniform(0.41, 0.54),
        },
    }
