...
def nn_cifar10(rng):
    return {
        ...
        "l2": {
            "adam_beta_1": np.exp(rng.uniform(-1.88, -0.98)),
            "adam_beta_2": np.exp(rng.uniform(-5.65, -4.63)),
            "adam_eps": np.exp(rng.uniform(-22.36, -18.68)),
            "adam_wd": np.exp(rng.uniform(-11.93, -10.55)),
            "max_lr": np.exp(rng.uniform(-5.49, -5.33)),
            "cycle_peak": rng.uniform(0.34, 0.38),
        },
        "max": {
            "adam_beta_1": np.exp(rng.uniform(-4.46, -3.82)),
            "adam_beta_2": np.exp(rng.uniform(-9.65, -8.92)),
            "adam_eps": np.exp(rng.uniform(-16.84, -15.08)),
            "adam_wd": np.exp(rng.uniform(-12.71, -7.31)),
            "max_lr": np.exp(rng.uniform(-7.3, -6.33)),
            "cycle_peak": rng.uniform(0.35, 0.42),
        },
        "relu": {
            "adam_beta_1": np.exp(rng.uniform(-3.27, -1.47)),
            "adam_beta_2": np.exp(rng.uniform(-7.02, -5.86)),
            "adam_eps": np.exp(rng.uniform(-21.62, -18.6)),
            "adam_wd": np.exp(rng.uniform(-10.6, -10.19)),
            "max_lr": np.exp(rng.uniform(-7.4, -7.09)),
            "cycle_peak": rng.uniform(0.31, 0.35),
        },
    }
...
def nn_cifar100(rng):
    return {
        ...
        "l2": {
            "adam_beta_1": np.exp(rng.uniform(-1.19, -1.15)),
            "adam_beta_2": np.exp(rng.uniform(-6.07, -5.62)),
            "adam_eps": np.exp(rng.uniform(-21.71, -19.43)),
            "adam_wd": np.exp(rng.uniform(-11.84, -11.12)),
            "max_lr": np.exp(rng.uniform(-5.44, -5.19)),
            "cycle_peak": rng.uniform(0.46, 0.53),
        },
        "max": {
            "adam_beta_1": np.exp(rng.uniform(-1.25, -1.06)),
            "adam_beta_2": np.exp(rng.uniform(-6.41, -5.9)),
            "adam_eps": np.exp(rng.uniform(-21.16, -17.38)),
            "adam_wd": np.exp(rng.uniform(-12.2, -7.99)),
            "max_lr": np.exp(rng.uniform(-7.5, -7.29)),
            "cycle_peak": rng.uniform(0.23, 0.26),
        },
        "relu": {
            "adam_beta_1": np.exp(rng.uniform(-2.85, -2.79)),
            "adam_beta_2": np.exp(rng.uniform(-8.81, -6.61)),
            "adam_eps": np.exp(rng.uniform(-23.82, -18.1)),
            "adam_wd": np.exp(rng.uniform(-9.53, -7.94)),
            "max_lr": np.exp(rng.uniform(-7.03, -6.88)),
            "cycle_peak": rng.uniform(0.44, 0.53),
        },
    }
