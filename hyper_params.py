...
def nn_mnist(rng):
    return {
        ...
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.6, -1.34)),
            "adam_beta_2": np.exp(rng.uniform(-9.47, -3.87)),
            "adam_eps": np.exp(rng.uniform(-21.09, -14.66)),
            "adam_wd": np.exp(rng.uniform(-13.92, -8.55)),
            "max_lr": np.exp(rng.uniform(-7.1, -4.92)),
            "cycle_peak": rng.uniform(0.26, 0.42),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-4.11, -3.1)),
            "adam_beta_2": np.exp(rng.uniform(-11.06, -4.03)),
            "adam_eps": np.exp(rng.uniform(-21.58, -16.09)),
            "adam_wd": np.exp(rng.uniform(-12.64, -8.44)),
            "max_lr": np.exp(rng.uniform(-7.37, -5.13)),
            "cycle_peak": rng.uniform(0.24, 0.36),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.45, -0.37)),
            "adam_beta_2": np.exp(rng.uniform(-5.85, -3.55)),
            "adam_eps": np.exp(rng.uniform(-22.01, -17.75)),
            "adam_wd": np.exp(rng.uniform(-14.17, -9.23)),
            "max_lr": np.exp(rng.uniform(-7.64, -5.56)),
            "cycle_peak": rng.uniform(0.13, 0.41),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.98, -3.55)),
            "adam_beta_2": np.exp(rng.uniform(-11.54, -10.26)),
            "adam_eps": np.exp(rng.uniform(-21.46, -14.98)),
            "adam_wd": np.exp(rng.uniform(-12.27, -8.13)),
            "max_lr": np.exp(rng.uniform(-7.52, -5.36)),
            "cycle_peak": rng.uniform(0.1, 0.33),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.5, -1.86)),
            "adam_beta_2": np.exp(rng.uniform(-11.82, -6.92)),
            "adam_eps": np.exp(rng.uniform(-22.4, -17.55)),
            "adam_wd": np.exp(rng.uniform(-14.24, -10.9)),
            "max_lr": np.exp(rng.uniform(-8.24, -6.06)),
            "cycle_peak": rng.uniform(0.14, 0.37),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.25, -1.94)),
            "adam_beta_2": np.exp(rng.uniform(-10.89, -4.07)),
            "adam_eps": np.exp(rng.uniform(-22.24, -16.58)),
            "adam_wd": np.exp(rng.uniform(-13.37, -6.44)),
            "max_lr": np.exp(rng.uniform(-7.97, -5.37)),
            "cycle_peak": rng.uniform(0.14, 0.34),
        },
...
def cnn_mnist(rng):
    return {
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-4.36, -2.86)),
            "adam_beta_2": np.exp(rng.uniform(-9.03, -4.2)),
            "adam_eps": np.exp(rng.uniform(-19.74, -15.61)),
            "adam_wd": np.exp(rng.uniform(-12.81, -9.7)),
            "max_lr": np.exp(rng.uniform(-8.15, -6.9)),
            "cycle_peak": rng.uniform(0.16, 0.39),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.51, -2.72)),
            "adam_beta_2": np.exp(rng.uniform(-9.72, -7.66)),
            "adam_eps": np.exp(rng.uniform(-22.12, -18.31)),
            "adam_wd": np.exp(rng.uniform(-12.44, -7.69)),
            "max_lr": np.exp(rng.uniform(-7.52, -5.73)),
            "cycle_peak": rng.uniform(0.11, 0.4),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-4.8, -3.08)),
            "adam_beta_2": np.exp(rng.uniform(-9.48, -6.08)),
            "adam_eps": np.exp(rng.uniform(-22.93, -16.83)),
            "adam_wd": np.exp(rng.uniform(-12.1, -9.21)),
            "max_lr": np.exp(rng.uniform(-7.66, -5.87)),
            "cycle_peak": rng.uniform(0.05, 0.44),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-5.15, -2.96)),
            "adam_beta_2": np.exp(rng.uniform(-9.99, -4.8)),
            "adam_eps": np.exp(rng.uniform(-19.16, -16.39)),
            "adam_wd": np.exp(rng.uniform(-14.03, -10.82)),
            "max_lr": np.exp(rng.uniform(-7.79, -6.49)),
            "cycle_peak": rng.uniform(0.26, 0.41),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.47, -2.03)),
            "adam_beta_2": np.exp(rng.uniform(-11.76, -5.75)),
            "adam_eps": np.exp(rng.uniform(-21.93, -15.97)),
            "adam_wd": np.exp(rng.uniform(-11.36, -7.13)),
            "max_lr": np.exp(rng.uniform(-8.01, -6.49)),
            "cycle_peak": rng.uniform(0.1, 0.4),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.47, -2.86)),
            "adam_beta_2": np.exp(rng.uniform(-12.08, -6.07)),
            "adam_eps": np.exp(rng.uniform(-21.11, -17.36)),
            "adam_wd": np.exp(rng.uniform(-12.57, -9.58)),
            "max_lr": np.exp(rng.uniform(-8.47, -5.8)),
            "cycle_peak": rng.uniform(0.2, 0.3),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.0, -1.91)),
            "adam_beta_2": np.exp(rng.uniform(-7.47, -5.3)),
            "adam_eps": np.exp(rng.uniform(-20.15, -15.73)),
            "adam_wd": np.exp(rng.uniform(-10.87, -9.05)),
            "max_lr": np.exp(rng.uniform(-7.36, -7.06)),
