...
def nn_cifar10(rng):
    return {
        ...
        "combinact": {
            "adam_beta_1": np.exp(rng.uniform(-1.58, -0.51)),
            "adam_beta_2": np.exp(rng.uniform(-5.15, -4.48)),
            "adam_eps": np.exp(rng.uniform(-18.9, -15.34)),
            "adam_wd": np.exp(rng.uniform(-14.9, -10.99)),
            "max_lr": np.exp(rng.uniform(-6.7, -5.5)),
            "cycle_peak": rng.uniform(0.34, 0.45),
        },
        "min": {
...
def nn_cifar100(rng):
    return {
        ...
        "combinact": {
            "adam_beta_1": np.exp(rng.uniform(-0.62, -0.39)),
            "adam_beta_2": np.exp(rng.uniform(-7.15, -5.45)),
            "adam_eps": np.exp(rng.uniform(-22.86, -22.45)),
            "adam_wd": np.exp(rng.uniform(-11.59, -11.02)),
            "max_lr": np.exp(rng.uniform(-6.44, -5.89)),
