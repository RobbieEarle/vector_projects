...
def nn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-1.11, 0.24)),
            "adam_beta_2": np.power(10., rng.uniform(-1.61, 0.27)),
            "adam_eps": np.power(10., rng.uniform(-9.42, -7.68)),
            "adam_wd": np.power(10., rng.uniform(-5.0, -4.01)),
            "max_lr": np.power(10., rng.uniform(-2.69, -2.37)),
            "cycle_peak": rng.uniform(0.21, 0.38),
        },
        "swish": {
            "adam_beta_1": np.power(10., rng.uniform(-0.67, -0.2)),
            "adam_beta_2": np.power(10., rng.uniform(-1.4, 0.35)),
...
def cnn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-1.37, -0.5)),
            "adam_beta_2": np.power(10., rng.uniform(-2.4, 0.03)),
            "adam_eps": np.power(10., rng.uniform(-8.74, -6.44)),
            "adam_wd": np.power(10., rng.uniform(-5.32, -4.47)),
            "max_lr": np.power(10., rng.uniform(-3.6, -2.92)),
            "cycle_peak": rng.uniform(0.21, 0.43),
        },
        "swish": {
