...
def nn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-1.18, 0.0)),
            "adam_beta_2": np.power(10., rng.uniform(-1.37, -0.9)),
            "adam_eps": np.power(10., rng.uniform(-9.51, -7.27)),
            "adam_wd": np.power(10., rng.uniform(-6.03, -4.81)),
            "max_lr": np.power(10., rng.uniform(-2.68, -2.16)),
            "cycle_peak": rng.uniform(0.22, 0.32),
        },
        "swish": {
            "adam_beta_1": np.power(10., rng.uniform(-0.67, -0.2)),
            "adam_beta_2": np.power(10., rng.uniform(-1.4, 0.0)),
            "adam_eps": np.power(10., rng.uniform(-9.56, -7.04)),
            "adam_wd": np.power(10., rng.uniform(-4.72, -4.0)),
            "max_lr": np.power(10., rng.uniform(-2.74, -2.31)),
            "cycle_peak": rng.uniform(0.23, 0.37),
        },
        "swishk_p_inv": {
            "adam_beta_1": np.power(10., rng.uniform(-2.25, -1.19)),
            "adam_beta_2": np.power(10., rng.uniform(-0.15, -0.02)),
            "adam_eps": np.power(10., rng.uniform(-9.15, -6.41)),
            "adam_wd": np.power(10., rng.uniform(-4.58, -3.09)),
            "max_lr": np.power(10., rng.uniform(-2.95, -2.38)),
            "cycle_peak": rng.uniform(0.08, 0.52),
        },
...
def cnn_mnist(rng):
    return {
        ...
        "swishk_p": {
            "adam_beta_1": np.power(10., rng.uniform(-1.3, 0.0)),
            "adam_beta_2": np.power(10., rng.uniform(-1.33, -0.45)),
            "adam_eps": np.power(10., rng.uniform(-9.62, -7.76)),
            "adam_wd": np.power(10., rng.uniform(-5.09, -4.03)),
            "max_lr": np.power(10., rng.uniform(-3.04, -2.73)),
            "cycle_peak": rng.uniform(0.37, 0.49),
        },
        "swish": {
            "adam_beta_1": np.power(10., rng.uniform(-1.43, -0.76)),
            "adam_beta_2": np.power(10., rng.uniform(-2.57, -0.14)),
            "adam_eps": np.power(10., rng.uniform(-9.01, -6.39)),
            "adam_wd": np.power(10., rng.uniform(-5.41, -4.51)),
            "max_lr": np.power(10., rng.uniform(-3.53, -3.16)),
            "cycle_peak": rng.uniform(0.23, 0.37),
        },
        "swishk_p_inv": {
            "adam_beta_1": np.power(10., rng.uniform(-1.35, -0.48)),
            "adam_beta_2": np.power(10., rng.uniform(-1.88, -1.25)),
            "adam_eps": np.power(10., rng.uniform(-8.68, -5.77)),
            "adam_wd": np.power(10., rng.uniform(-5.17, -4.8)),
            "max_lr": np.power(10., rng.uniform(-3.58, -2.8)),
            "cycle_peak": rng.uniform(0.24, 0.35),
        },
    }
