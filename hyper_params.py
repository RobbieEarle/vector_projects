...
def nn_mnist(rng):
    return {
        ...
        "swishk": {
            "adam_beta_1": np.power(10., -0.922),
            "adam_beta_2": np.power(10., -4.085),
            "adam_eps": np.power(10., -7.57),
            "adam_wd": np.power(10., -5.1477),
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-4.18, -0.51)),
            "adam_beta_2": np.exp(rng.uniform(-7.03, -4.92)),
            "adam_eps": np.exp(rng.uniform(-22.38, -17.22)),
            "adam_wd": np.exp(rng.uniform(-14.07, -9.89)),
            "max_lr": np.exp(rng.uniform(-7.61, -4.84)),
            "cycle_peak": rng.uniform(0.07, 0.39),
        },
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-2.51, -1.59)),
            "adam_beta_2": np.exp(rng.uniform(-6.66, -5.48)),
            "adam_eps": np.exp(rng.uniform(-21.46, -19.93)),
            "adam_wd": np.exp(rng.uniform(-13.01, -11.04)),
            "max_lr": np.exp(rng.uniform(-6.24, -5.43)),
            "cycle_peak": rng.uniform(0.12, 0.27),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-2.47, -1.38)),
            "adam_beta_2": np.exp(rng.uniform(-6.3, -4.71)),
            "adam_eps": np.exp(rng.uniform(-17.81, -15.82)),
            "adam_wd": np.exp(rng.uniform(-11.74, -11.32)),
            "max_lr": np.exp(rng.uniform(-6.51, -6.21)),
            "cycle_peak": rng.uniform(0.37, 0.38),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-3.54, -3.03)),
            "adam_beta_2": np.exp(rng.uniform(-9.55, -4.3)),
            "adam_eps": np.exp(rng.uniform(-20.03, -17.8)),
            "adam_wd": np.exp(rng.uniform(-10.26, -8.92)),
            "max_lr": np.exp(rng.uniform(-6.37, -5.9)),
            "cycle_peak": rng.uniform(0.26, 0.29),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-2.65, -2.15)),
            "adam_beta_2": np.exp(rng.uniform(-5.44, -4.26)),
            "adam_eps": np.exp(rng.uniform(-21.25, -19.54)),
            "adam_wd": np.exp(rng.uniform(-12.74, -10.71)),
            "max_lr": np.exp(rng.uniform(-7.16, -5.23)),
            "cycle_peak": rng.uniform(0.18, 0.28),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.82, -3.75)),
            "adam_beta_2": np.exp(rng.uniform(-10.9, -10.12)),
            "adam_eps": np.exp(rng.uniform(-20.83, -15.93)),
            "adam_wd": np.exp(rng.uniform(-11.53, -10.14)),
            "max_lr": np.exp(rng.uniform(-6.05, -5.12)),
            "cycle_peak": rng.uniform(0.14, 0.25),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.14, -2.86)),
            "adam_beta_2": np.exp(rng.uniform(-10.11, -6.56)),
            "adam_eps": np.exp(rng.uniform(-20.14, -17.1)),
            "adam_wd": np.exp(rng.uniform(-14.01, -13.02)),
            "max_lr": np.exp(rng.uniform(-7.53, -5.77)),
            "cycle_peak": rng.uniform(0.15, 0.21),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.41, -2.66)),
            "adam_beta_2": np.exp(rng.uniform(-9.03, -4.11)),
            "adam_eps": np.exp(rng.uniform(-18.37, -16.69)),
            "adam_wd": np.exp(rng.uniform(-11.64, -5.75)),
            "max_lr": np.exp(rng.uniform(-7.2, -6.6)),
            "cycle_peak": rng.uniform(0.19, 0.24),
        },
...
def nn_cifar100(rng):
    return {
        ...
        "max": {
            "adam_beta_1": np.power(10., -0.4834),
            "adam_beta_2": np.power(10., -2.5732),
            "adam_eps": np.power(10., -9.1315),
            "adam_wd": np.power(10., -3.5013),
            "max_lr": np.power(10., -3.1899),
            "cycle_peak": 0.24,
        },
        "relu": {
            "adam_beta_1": np.power(10., -1.2273),
            "adam_beta_2": np.power(10., -3.1582),
            "adam_eps": np.power(10., -8.8887),
            "adam_wd": np.power(10., -3.7601),
            "max_lr": np.power(10., -3.0531),
            "cycle_peak": 0.49,
        },
    }
...
def cnn_mnist(rng):
    return {
        ...
        "swishk": {
            "adam_beta_1": np.power(10., -0.86077),
            "adam_beta_2": np.power(10., -2.3934),
            "adam_eps": np.power(10., -8.0518),
            "adam_wd": np.power(10., -4.8914),
        ...
        "ail_or": {
            "adam_beta_1": np.exp(rng.uniform(-3.64, -3.15)),
            "adam_beta_2": np.exp(rng.uniform(-9.68, -6.16)),
            "adam_eps": np.exp(rng.uniform(-19.29, -18.33)),
            "adam_wd": np.exp(rng.uniform(-11.08, -10.39)),
            "max_lr": np.exp(rng.uniform(-8.18, -7.19)),
            "cycle_peak": rng.uniform(0.21, 0.45),
        },
        "ail_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.41, -3.34)),
            "adam_beta_2": np.exp(rng.uniform(-9.57, -9.47)),
            "adam_eps": np.exp(rng.uniform(-21.94, -18.59)),
            "adam_wd": np.exp(rng.uniform(-9.85, -8.77)),
            "max_lr": np.exp(rng.uniform(-7.38, -6.89)),
            "cycle_peak": rng.uniform(0.26, 0.31),
        },
        "ail_all_or_and": {
            "adam_beta_1": np.exp(rng.uniform(-4.44, -3.69)),
            "adam_beta_2": np.exp(rng.uniform(-9.7, -6.72)),
            "adam_eps": np.exp(rng.uniform(-23.74, -18.33)),
            "adam_wd": np.exp(rng.uniform(-10.0, -9.3)),
            "max_lr": np.exp(rng.uniform(-7.32, -7.07)),
            "cycle_peak": rng.uniform(0.05, 0.1),
        },
        "ail_all_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-4.58, -3.1)),
            "adam_beta_2": np.exp(rng.uniform(-7.97, -5.42)),
            "adam_eps": np.exp(rng.uniform(-19.0, -16.39)),
            "adam_wd": np.exp(rng.uniform(-12.18, -10.99)),
            "max_lr": np.exp(rng.uniform(-7.64, -6.94)),
            "cycle_peak": rng.uniform(0.24, 0.4),
        },
        "ail_all_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.62, -3.36)),
            "adam_beta_2": np.exp(rng.uniform(-10.41, -8.27)),
            "adam_eps": np.exp(rng.uniform(-20.96, -17.99)),
            "adam_wd": np.exp(rng.uniform(-10.98, -7.99)),
            "max_lr": np.exp(rng.uniform(-8.03, -7.14)),
            "cycle_peak": rng.uniform(0.16, 0.35),
        },
        "ail_part_or_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.44, -2.99)),
            "adam_beta_2": np.exp(rng.uniform(-7.13, -6.26)),
            "adam_eps": np.exp(rng.uniform(-19.7, -17.97)),
            "adam_wd": np.exp(rng.uniform(-12.73, -9.37)),
            "max_lr": np.exp(rng.uniform(-8.28, -6.13)),
            "cycle_peak": rng.uniform(0.2, 0.25),
        },
        "ail_part_or_and_xnor": {
            "adam_beta_1": np.exp(rng.uniform(-3.69, -2.86)),
            "adam_beta_2": np.exp(rng.uniform(-7.23, -6.45)),
            "adam_eps": np.exp(rng.uniform(-18.34, -17.12)),
            "adam_wd": np.exp(rng.uniform(-10.44, -9.98)),
            "max_lr": np.exp(rng.uniform(-7.2, -7.05)),
            "cycle_peak": rng.uniform(0.25, 0.32),
        },
    }
...
def resnet_mnist(rng):
    return {
        ...
        "relu": {
            "adam_beta_1": np.power(10., rng.uniform(-3, 0)),
            "adam_beta_2": np.power(10., rng.uniform(-3, 0)),
            "adam_eps": np.power(10., rng.uniform(-10, -4)),
