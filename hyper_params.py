...
def nn_mnist(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.83, -4.12)),
            "adam_beta_2": np.exp(rng.uniform(-7.69, -5.61)),
            "adam_eps": np.exp(rng.uniform(-20.19, -18.93)),
            "adam_wd": np.exp(rng.uniform(-13.48, -12.56)),
            "max_lr": np.exp(rng.uniform(-8.08, -7.27)),
            "cycle_peak": rng.uniform(0.38, 0.41),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-2.94, -2.24)),
            "adam_beta_2": np.exp(rng.uniform(-6.29, -4.9)),
            "adam_eps": np.exp(rng.uniform(-19.92, -15.9)),
            "adam_wd": np.exp(rng.uniform(-10.48, -9.01)),
            "max_lr": np.exp(rng.uniform(-8.19, -6.99)),
            "cycle_peak": rng.uniform(0.14, 0.53),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-3.83, -3.06)),
            "adam_beta_2": np.exp(rng.uniform(-9.76, -5.59)),
            "adam_eps": np.exp(rng.uniform(-19.06, -16.76)),
            "adam_wd": np.exp(rng.uniform(-13.0, -10.46)),
            "max_lr": np.exp(rng.uniform(-7.91, -7.02)),
            "cycle_peak": rng.uniform(0.17, 0.25),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-5.39, -3.93)),
            "adam_beta_2": np.exp(rng.uniform(-9.66, -4.98)),
            "adam_eps": np.exp(rng.uniform(-15.54, -14.8)),
            "adam_wd": np.exp(rng.uniform(-13.36, -11.72)),
            "max_lr": np.exp(rng.uniform(-6.32, -5.37)),
            "cycle_peak": rng.uniform(0.21, 0.48),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-4.45, -2.9)),
            "adam_beta_2": np.exp(rng.uniform(-12.63, -4.99)),
            "adam_eps": np.exp(rng.uniform(-21.53, -17.03)),
            "adam_wd": np.exp(rng.uniform(-10.12, -8.92)),
            "max_lr": np.exp(rng.uniform(-6.52, -6.25)),
...
def nn_cifar10(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.82, -4.19)),
            "adam_beta_2": np.exp(rng.uniform(-5.71, -3.36)),
            "adam_eps": np.exp(rng.uniform(-18.81, -17.65)),
            "adam_wd": np.exp(rng.uniform(-11.84, -9.26)),
            "max_lr": np.exp(rng.uniform(-7.56, -6.17)),
            "cycle_peak": rng.uniform(0.4, 0.43),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-4.55, -3.81)),
            "adam_beta_2": np.exp(rng.uniform(-11.32, -5.81)),
            "adam_eps": np.exp(rng.uniform(-20.68, -19.2)),
            "adam_wd": np.exp(rng.uniform(-11.99, -8.26)),
            "max_lr": np.exp(rng.uniform(-7.29, -7.01)),
            "cycle_peak": rng.uniform(0.38, 0.56),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.72, -2.99)),
            "adam_beta_2": np.exp(rng.uniform(-11.33, -4.04)),
            "adam_eps": np.exp(rng.uniform(-18.98, -16.22)),
            "adam_wd": np.exp(rng.uniform(-14.12, -13.24)),
            "max_lr": np.exp(rng.uniform(-7.37, -5.62)),
            "cycle_peak": rng.uniform(0.23, 0.32),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-4.95, -1.99)),
            "adam_beta_2": np.exp(rng.uniform(-7.48, -2.99)),
            "adam_eps": np.exp(rng.uniform(-20.95, -19.36)),
            "adam_wd": np.exp(rng.uniform(-13.7, -7.75)),
            "max_lr": np.exp(rng.uniform(-7.7, -6.53)),
            "cycle_peak": rng.uniform(0.33, 0.44),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-3.17, -2.71)),
            "adam_beta_2": np.exp(rng.uniform(-6.2, -4.6)),
            "adam_eps": np.exp(rng.uniform(-21.27, -15.33)),
            "adam_wd": np.exp(rng.uniform(-10.53, -9.4)),
            "max_lr": np.exp(rng.uniform(-6.01, -5.23)),
            "cycle_peak": rng.uniform(0.3, 0.53),
        },
        "groupsort": {"adam_beta_1": np.exp(rng.uniform(-5, 0)),
                      "adam_beta_2": np.exp(rng.uniform(-12, -4)),
                      "adam_eps": np.exp(rng.uniform(-22, -15)),
...
def nn_cifar100(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.49, -3.63)),
            "adam_beta_2": np.exp(rng.uniform(-7.92, -2.31)),
            "adam_eps": np.exp(rng.uniform(-18.79, -17.73)),
            "adam_wd": np.exp(rng.uniform(-10.54, -9.13)),
            "max_lr": np.exp(rng.uniform(-7.96, -6.72)),
            "cycle_peak": rng.uniform(0.3, 0.35),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.01, -0.73)),
            "adam_beta_2": np.exp(rng.uniform(-5.06, -4.0)),
            "adam_eps": np.exp(rng.uniform(-20.99, -16.12)),
            "adam_wd": np.exp(rng.uniform(-14.45, -12.88)),
            "max_lr": np.exp(rng.uniform(-7.5, -6.61)),
            "cycle_peak": rng.uniform(0.21, 0.51),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-3.12, -2.39)),
            "adam_beta_2": np.exp(rng.uniform(-8.63, -6.25)),
            "adam_eps": np.exp(rng.uniform(-18.49, -17.23)),
            "adam_wd": np.exp(rng.uniform(-13.07, -9.85)),
            "max_lr": np.exp(rng.uniform(-9, -4.36)),
            "cycle_peak": rng.uniform(0.23, 0.35),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.22, -0.68)),
            "adam_beta_2": np.exp(rng.uniform(-6.0, -5.6)),
            "adam_eps": np.exp(rng.uniform(-20.53, -17.85)),
            "adam_wd": np.exp(rng.uniform(-12.67, -11.61)),
            "max_lr": np.exp(rng.uniform(-9, -7.96)),
            "cycle_peak": rng.uniform(0.33, 0.42),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-0.52, -0.08)),
            "adam_beta_2": np.exp(rng.uniform(-7.08, -6.41)),
            "adam_eps": np.exp(rng.uniform(-20.05, -17.3)),
            "adam_wd": np.exp(rng.uniform(-15.52, -10.96)),
            "max_lr": np.exp(rng.uniform(-8.33, -7.61)),
...
def cnn_mnist(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.51, -4.24)),
            "adam_beta_2": np.exp(rng.uniform(-9.82, -8.92)),
            "adam_eps": np.exp(rng.uniform(-18.97, -17.01)),
            "adam_wd": np.exp(rng.uniform(-13.88, -13.52)),
            "max_lr": np.exp(rng.uniform(-7.15, -6.83)),
            "cycle_peak": rng.uniform(0.24, 0.42),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-4.22, -3.76)),
            "adam_beta_2": np.exp(rng.uniform(-8.12, -5.9)),
            "adam_eps": np.exp(rng.uniform(-17.71, -15.74)),
            "adam_wd": np.exp(rng.uniform(-12.77, -12.02)),
            "max_lr": np.exp(rng.uniform(-7.53, -6.67)),
            "cycle_peak": rng.uniform(0.19, 0.27),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.03, -3.22)),
            "adam_beta_2": np.exp(rng.uniform(-7.55, -4.73)),
            "adam_eps": np.exp(rng.uniform(-19.97, -17.91)),
            "adam_wd": np.exp(rng.uniform(-12.46, -10.15)),
            "max_lr": np.exp(rng.uniform(-7.73, -6.83)),
            "cycle_peak": rng.uniform(0.28, 0.36),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-4.0, -3.01)),
            "adam_beta_2": np.exp(rng.uniform(-8.83, -5.98)),
            "adam_eps": np.exp(rng.uniform(-16.95, -15.22)),
            "adam_wd": np.exp(rng.uniform(-13.94, -12.25)),
            "max_lr": np.exp(rng.uniform(-9, -6.55)),
            "cycle_peak": rng.uniform(0.29, 0.4),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-4.49, -3.82)),
            "adam_beta_2": np.exp(rng.uniform(-10.36, -7.31)),
            "adam_eps": np.exp(rng.uniform(-18.68, -16.51)),
            "adam_wd": np.exp(rng.uniform(-12.87, -10.3)),
            "max_lr": np.exp(rng.uniform(-9, -6.86)),
            "cycle_peak": rng.uniform(0.29, 0.38),
        },
        "lse": {
...
def cnn_cifar10(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.36, -3.93)),
            "adam_beta_2": np.exp(rng.uniform(-6.18, -4.71)),
            "adam_eps": np.exp(rng.uniform(-17.93, -16.11)),
            "adam_wd": np.exp(rng.uniform(-8.86, -7.09)),
            "max_lr": np.exp(rng.uniform(-7.34, -6.62)),
            "cycle_peak": rng.uniform(0.3, 0.37),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-4.26, -2.53)),
            "adam_beta_2": np.exp(rng.uniform(-6.75, -5.25)),
            "adam_eps": np.exp(rng.uniform(-19.47, -14.82)),
            "adam_wd": np.exp(rng.uniform(-8.32, -7.3)),
            "max_lr": np.exp(rng.uniform(-7.09, -6.88)),
            "cycle_peak": rng.uniform(0.35, 0.54),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.53, -3.26)),
            "adam_beta_2": np.exp(rng.uniform(-9.82, -3.7)),
            "adam_eps": np.exp(rng.uniform(-18.49, -17.96)),
            "adam_wd": np.exp(rng.uniform(-10.96, -7.2)),
            "max_lr": np.exp(rng.uniform(-6.85, -6.58)),
            "cycle_peak": rng.uniform(0.25, 0.34),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-3.0, -1.58)),
            "adam_beta_2": np.exp(rng.uniform(-5.07, -3.78)),
            "adam_eps": np.exp(rng.uniform(-20.49, -17.87)),
            "adam_wd": np.exp(rng.uniform(-15.63, -12.67)),
            "max_lr": np.exp(rng.uniform(-6.9, -6.37)),
            "cycle_peak": rng.uniform(0.27, 0.41),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-2.49, -0.86)),
            "adam_beta_2": np.exp(rng.uniform(-5.51, -4.26)),
            "adam_eps": np.exp(rng.uniform(-21.41, -18.11)),
            "adam_wd": np.exp(rng.uniform(-9.35, -8.54)),
            "max_lr": np.exp(rng.uniform(-6.82, -6.18)),
...
def cnn_cifar100(rng):
    return {
        ...
        "bin_partition_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.71, -4.24)),
            "adam_beta_2": np.exp(rng.uniform(-7.26, -1.83)),
            "adam_eps": np.exp(rng.uniform(-18.55, -17.7)),
            "adam_wd": np.exp(rng.uniform(-15.0, -10.29)),
            "max_lr": np.exp(rng.uniform(-6.87, -6.77)),
            "cycle_peak": rng.uniform(0.24, 0.29),
        },
        "bin_partition_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-1.95, -1.07)),
            "adam_beta_2": np.exp(rng.uniform(-5.6, -3.05)),
            "adam_eps": np.exp(rng.uniform(-18.41, -16.4)),
            "adam_wd": np.exp(rng.uniform(-13.11, -10.35)),
            "max_lr": np.exp(rng.uniform(-7.97, -7.08)),
            "cycle_peak": rng.uniform(0.28, 0.65),
        },
        "bin_all_full": {
            "adam_beta_1": np.exp(rng.uniform(-4.05, -3.66)),
            "adam_beta_2": np.exp(rng.uniform(-4.9, -2.88)),
            "adam_eps": np.exp(rng.uniform(-18.42, -16.71)),
            "adam_wd": np.exp(rng.uniform(-13.58, -10.21)),
            "max_lr": np.exp(rng.uniform(-6.96, -6.84)),
            "cycle_peak": rng.uniform(0.26, 0.34),
        },
        "bin_all_nopass": {
            "adam_beta_1": np.exp(rng.uniform(-2.2, -1.24)),
            "adam_beta_2": np.exp(rng.uniform(-3.54, -3.09)),
            "adam_eps": np.exp(rng.uniform(-21.17, -17.74)),
            "adam_wd": np.exp(rng.uniform(-14.75, -13.52)),
            "max_lr": np.exp(rng.uniform(-7.15, -6.72)),
            "cycle_peak": rng.uniform(0.22, 0.37),
        },
        "bin_all_nopass_sgm": {
            "adam_beta_1": np.exp(rng.uniform(-2.88, -1.3)),
            "adam_beta_2": np.exp(rng.uniform(-9.32, -5.17)),
            "adam_eps": np.exp(rng.uniform(-19.37, -16.41)),
            "adam_wd": np.exp(rng.uniform(-10.88, -6.64)),
            "max_lr": np.exp(rng.uniform(-6.95, -6.74)),
            "cycle_peak": rng.uniform(0.35, 0.53),
        },
        "lse": {
